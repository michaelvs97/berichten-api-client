...
{
    /// <summary>
    ///  Class for testing BereikbaarheidApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class BereikbaarheidApiTests : IDisposable
    {
        private BereikbaarheidApi instance;

        public BereikbaarheidApiTests()
        {
            instance = new BereikbaarheidApi();
        }
        ...
        /// <summary>
        /// Test an instance of BereikbaarheidApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' BereikbaarheidApi
            //Assert.IsType<BereikbaarheidApi>(instance);
        }
