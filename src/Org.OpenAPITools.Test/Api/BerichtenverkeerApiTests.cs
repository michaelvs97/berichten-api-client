...
{
    /// <summary>
    ///  Class for testing BerichtenverkeerApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class BerichtenverkeerApiTests : IDisposable
    {
        private BerichtenverkeerApi instance;

        public BerichtenverkeerApiTests()
        {
            instance = new BerichtenverkeerApi();
        }
        ...
        /// <summary>
        /// Test an instance of BerichtenverkeerApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' BerichtenverkeerApi
            //Assert.IsType<BerichtenverkeerApi>(instance);
        }
        ...
        public void DeleteMessagesTest()
        {
            ...
            //List<Guid> berichtTransportIdsParam = null;
            //var response = instance.DeleteMessages(berichtTransportIdsParam);
            //Assert.IsType<DeleteMessageAntwoord>(response);
        }
        ...
        public void GetMessagesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<Guid> berichtTransportIdsParam = null;
            //var response = instance.GetMessages(berichtTransportIdsParam);
            //Assert.IsType<GetMessageAntwoord>(response);
        }
        ...
        public void ListMessagesTest()
        {
            ...
            //string? berichtType = null;
            //DateTime? vanafMoment = null;
            //DateTime? totMoment = null;
            //int? pagina = null;
            //int? berichtenPerPagina = null;
            //var response = instance.ListMessages(status, berichtType, vanafMoment, totMoment, pagina, berichtenPerPagina);
            //Assert.IsType<ListMessageAntwoord>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void PutMessagesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //PutMessageRequest putMessageRequest = null;
            //var response = instance.PutMessages(putMessageRequest);
            //Assert.IsType<PutMessageAntwoord>(response);
        }
        ...
        public void SummarizeTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string soort = null;
            //var response = instance.Summarize(soort);
            //Assert.IsType<Summarize200Response>(response);
        }
    }
}
