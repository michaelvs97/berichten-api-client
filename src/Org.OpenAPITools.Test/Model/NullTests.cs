...
namespace Org.OpenAPITools.Test.Model
{
    ...
    {
        // TODO uncomment below to declare an instance variable for Null
        //private Null instance;

        public NullTests()
        {
            // TODO uncomment below to create an instance of Null
            //instance = new Null();
        }
        ...
        /// <summary>
        /// Test an instance of Null
        /// </summary>
        [Fact]
        public void NullInstanceTest()
        {
            // TODO uncomment below to test "IsType" Null
            //Assert.IsType<Null>(instance);
        }
