...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface IBerichtconversieApiSync : IApiAccessor
    {
        ...
        /// <param name="body">Er zijn verschillende waarden die voor de headers &#x60;Content-Type&#x60; en &#x60;Accept&#x60; gebruikt kunnen worden. Elk van deze waarden stelt een van de bekende formaten voor:   - \&quot;text/plain; charset&#x3D;teletex\&quot;: Het klassieke berichtenformaat waarbij de teletex charset wordt gehanteerd.   - \&quot;text/plain+base64; charset&#x3D;teletex\&quot;: Het klassieke berichtenformaat waarbij de teletex charset wordt gehanteerd. De body is in dit geval Base64 geëncodeerd.   - \&quot;text/plain; charset&#x3D;utf-8\&quot;: Het klassieke berichtenformaat waarbij de UTF-8 charset wordt gehanteerd.   - \&quot;text/plain+base64; charset&#x3D;utf-8\&quot;: Het klassieke berichtenformaat waarbij de UTF-8 charset wordt gehanteerd. De body is in dit geval Base64 geëncodeerd.   - \&quot;application/json\&quot;: Het meest recente berichtenformaat gebaseerd op JSON en de UTF-8 charset.  Middels deze waarden kunt u via de Content-Type en Accept headers aanduiden welk formaat u instuurt en welk formaat u terug wenst te ontvangen. </param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Converteer200Response</returns>
        ApiResponse<Converteer200Response> ConverteerWithHttpInfo(string body, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBerichtconversieApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of Converteer200Response</returns>
        System.Threading.Tasks.Task<Converteer200Response> ConverteerAsync(string body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Converteer200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<Converteer200Response>> ConverteerWithHttpInfoAsync(string body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBerichtconversieApi : IBerichtconversieApiSync, IBerichtconversieApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BerichtconversieApi : IBerichtconversieApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BerichtconversieApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BerichtconversieApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public BerichtconversieApi(string basePath)
        {
        ...
        /// <returns></returns>
        public BerichtconversieApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public BerichtconversieApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Converteer200Response</returns>
        public Converteer200Response Converteer(string body, int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<Converteer200Response> localVarResponse = ConverteerWithHttpInfo(body);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Converteer200Response</returns>
        public Org.OpenAPITools.Client.ApiResponse<Converteer200Response> ConverteerWithHttpInfo(string body, int operationIndex = 0)
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'body' when calling BerichtconversieApi->Converteer");
            }
            ...
            localVarRequestOptions.Operation = "BerichtconversieApi.Converteer";
            ...
            var localVarResponse = this.Client.Post<Converteer200Response>("/berichten/conversie", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("Converteer", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Converteer200Response</returns>
        public async System.Threading.Tasks.Task<Converteer200Response> ConverteerAsync(string body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Org.OpenAPITools.Client.ApiResponse<Converteer200Response> localVarResponse = await ConverteerWithHttpInfoAsync(body, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Converteer200Response)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Converteer200Response>> ConverteerWithHttpInfoAsync(string body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Converteer200Response>("/berichten/conversie", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
