...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlData
    /// </summary>
    [DataContract(Name = "Af01_plData")]
    public partial class Af01PlData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlData" /> class.
        /// </summary>
        /// <param name="c01">Gegevens over de ingeschrevene.</param>
        /// <param name="c02">Gegevens over de ouder1 van de ingeschrevene..</param>
        /// <param name="c03">Gegevens over de ouder2 van de ingeschrevene..</param>
        /// <param name="c04">Gegevens over een nationaliteit van de ingeschrevene..</param>
        /// <param name="c05">Gegevens over een gesloten of ontbonden huwelijk/geregistreerd partnerschap van de ingeschrevene..</param>
        /// <param name="c06">Gegevens over het overlijden van de ingeschrevene..</param>
        /// <param name="c07">Gegevens over de opneming en de status van de PL..</param>
        /// <param name="c08">Gegevens over het verblijf en adres van de ingeschrevene..</param>
        /// <param name="c09">Gegevens over een kind van de ingeschrevene..</param>
        /// <param name="c10">Gegevens over de verblijfsrechtelijke status van de ingeschrevene..</param>
        /// <param name="c11">Gegevens betreffende het gezag over de ingeschrevene..</param>
        /// <param name="c12">Gegevens over een reisdocument van de ingeschrevene..</param>
        /// <param name="c13">Gegevens over het kiesrecht van de ingeschrevene..</param>
        /// <param name="c14">persoonslijst is wel of niet meer onderdeel van de doelgroep van een afnemer of derde..</param>
        /// <param name="c15">Gegevens over een aantekening uit vak 6 of vak 23 van de PK van de ingeschrevene..</param>
        /// <param name="c16">Adres waar betrokkene tijdelijk woont tijdens diens verblijf in Nederland..</param>
        /// <param name="c17">Telefoonnummer en/of e-mailadres waarop betrokkene bereikbaar is tijdens diens verblijf in Nederland..</param>
        /// <param name="c21">Gegevens over de eerste of volgende gemeente van inschrijving of de RNI van de ingeschrevene..</param>
        public Af01PlData(List<Af01PlDataC01Inner> c01 = default, List<Af01PlDataC02Inner> c02 = default, List<Af01PlDataC02Inner> c03 = default, List<Af01PlDataC04Inner> c04 = default, List<Af01PlDataC05Inner> c05 = default, List<Af01PlDataC06Inner> c06 = default, List<Af01PlDataC07Inner> c07 = default, List<Af01PlDataC08Inner> c08 = default, List<Af01PlDataC09Inner> c09 = default, List<Af01PlDataC10Inner> c10 = default, List<Af01PlDataC11Inner> c11 = default, List<Af01PlDataC12Inner> c12 = default, List<Af01PlDataC13Inner> c13 = default, List<Af01PlDataC14Inner> c14 = default, List<Af01PlDataC15Inner> c15 = default, List<Af01PlDataC16Inner> c16 = default, List<Af01PlDataC17Inner> c17 = default, List<Af01PlDataC21Inner> c21 = default)
        {
            this.C01 = c01;
            this.C02 = c02;
            this.C03 = c03;
        ...
        /// </summary>
        /// <value>Gegevens over de ingeschrevene</value>
        [DataMember(Name = "c01", EmitDefaultValue = false)]
        public List<Af01PlDataC01Inner> C01 { get; set; }

        /// <summary>
        /// Gegevens over de ouder1 van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over de ouder1 van de ingeschrevene.</value>
        [DataMember(Name = "c02", EmitDefaultValue = false)]
        public List<Af01PlDataC02Inner> C02 { get; set; }

        /// <summary>
        /// Gegevens over de ouder2 van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over de ouder2 van de ingeschrevene.</value>
        [DataMember(Name = "c03", EmitDefaultValue = false)]
        public List<Af01PlDataC02Inner> C03 { get; set; }

        /// <summary>
        /// Gegevens over een nationaliteit van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over een nationaliteit van de ingeschrevene.</value>
        [DataMember(Name = "c04", EmitDefaultValue = false)]
        public List<Af01PlDataC04Inner> C04 { get; set; }

        /// <summary>
        /// Gegevens over een gesloten of ontbonden huwelijk/geregistreerd partnerschap van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over een gesloten of ontbonden huwelijk/geregistreerd partnerschap van de ingeschrevene.</value>
        [DataMember(Name = "c05", EmitDefaultValue = false)]
        public List<Af01PlDataC05Inner> C05 { get; set; }

        /// <summary>
        /// Gegevens over het overlijden van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over het overlijden van de ingeschrevene.</value>
        [DataMember(Name = "c06", EmitDefaultValue = false)]
        public List<Af01PlDataC06Inner> C06 { get; set; }

        /// <summary>
        /// Gegevens over de opneming en de status van de PL.
        /// </summary>
        /// <value>Gegevens over de opneming en de status van de PL.</value>
        [DataMember(Name = "c07", EmitDefaultValue = false)]
        public List<Af01PlDataC07Inner> C07 { get; set; }

        /// <summary>
        /// Gegevens over het verblijf en adres van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over het verblijf en adres van de ingeschrevene.</value>
        [DataMember(Name = "c08", EmitDefaultValue = false)]
        public List<Af01PlDataC08Inner> C08 { get; set; }

        /// <summary>
        /// Gegevens over een kind van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over een kind van de ingeschrevene.</value>
        [DataMember(Name = "c09", EmitDefaultValue = false)]
        public List<Af01PlDataC09Inner> C09 { get; set; }

        /// <summary>
        /// Gegevens over de verblijfsrechtelijke status van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over de verblijfsrechtelijke status van de ingeschrevene.</value>
        [DataMember(Name = "c10", EmitDefaultValue = false)]
        public List<Af01PlDataC10Inner> C10 { get; set; }

        /// <summary>
        /// Gegevens betreffende het gezag over de ingeschrevene.
        /// </summary>
        /// <value>Gegevens betreffende het gezag over de ingeschrevene.</value>
        [DataMember(Name = "c11", EmitDefaultValue = false)]
        public List<Af01PlDataC11Inner> C11 { get; set; }

        /// <summary>
        /// Gegevens over een reisdocument van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over een reisdocument van de ingeschrevene.</value>
        [DataMember(Name = "c12", EmitDefaultValue = false)]
        public List<Af01PlDataC12Inner> C12 { get; set; }

        /// <summary>
        /// Gegevens over het kiesrecht van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over het kiesrecht van de ingeschrevene.</value>
        [DataMember(Name = "c13", EmitDefaultValue = false)]
        public List<Af01PlDataC13Inner> C13 { get; set; }

        /// <summary>
        /// persoonslijst is wel of niet meer onderdeel van de doelgroep van een afnemer of derde.
        /// </summary>
        /// <value>persoonslijst is wel of niet meer onderdeel van de doelgroep van een afnemer of derde.</value>
        [DataMember(Name = "c14", EmitDefaultValue = false)]
        public List<Af01PlDataC14Inner> C14 { get; set; }

        /// <summary>
        /// Gegevens over een aantekening uit vak 6 of vak 23 van de PK van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over een aantekening uit vak 6 of vak 23 van de PK van de ingeschrevene.</value>
        [DataMember(Name = "c15", EmitDefaultValue = false)]
        public List<Af01PlDataC15Inner> C15 { get; set; }

        /// <summary>
        /// Adres waar betrokkene tijdelijk woont tijdens diens verblijf in Nederland.
        /// </summary>
        /// <value>Adres waar betrokkene tijdelijk woont tijdens diens verblijf in Nederland.</value>
        [DataMember(Name = "c16", EmitDefaultValue = false)]
        public List<Af01PlDataC16Inner> C16 { get; set; }

        /// <summary>
        /// Telefoonnummer en/of e-mailadres waarop betrokkene bereikbaar is tijdens diens verblijf in Nederland.
        /// </summary>
        /// <value>Telefoonnummer en/of e-mailadres waarop betrokkene bereikbaar is tijdens diens verblijf in Nederland.</value>
        [DataMember(Name = "c17", EmitDefaultValue = false)]
        public List<Af01PlDataC17Inner> C17 { get; set; }

        /// <summary>
        /// Gegevens over de eerste of volgende gemeente van inschrijving of de RNI van de ingeschrevene.
        /// </summary>
        /// <value>Gegevens over de eerste of volgende gemeente van inschrijving of de RNI van de ingeschrevene.</value>
        [DataMember(Name = "c21", EmitDefaultValue = false)]
        public List<Af01PlDataC21Inner> C21 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlData {\n");
            sb.Append("  C01: ").Append(C01).Append("\n");
            sb.Append("  C02: ").Append(C02).Append("\n");
            sb.Append("  C03: ").Append(C03).Append("\n");
            sb.Append("  C04: ").Append(C04).Append("\n");
            sb.Append("  C05: ").Append(C05).Append("\n");
            sb.Append("  C06: ").Append(C06).Append("\n");
            sb.Append("  C07: ").Append(C07).Append("\n");
            sb.Append("  C08: ").Append(C08).Append("\n");
            sb.Append("  C09: ").Append(C09).Append("\n");
            sb.Append("  C10: ").Append(C10).Append("\n");
            sb.Append("  C11: ").Append(C11).Append("\n");
            sb.Append("  C12: ").Append(C12).Append("\n");
            sb.Append("  C13: ").Append(C13).Append("\n");
            sb.Append("  C14: ").Append(C14).Append("\n");
            sb.Append("  C15: ").Append(C15).Append("\n");
            sb.Append("  C16: ").Append(C16).Append("\n");
            sb.Append("  C17: ").Append(C17).Append("\n");
            sb.Append("  C21: ").Append(C21).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
