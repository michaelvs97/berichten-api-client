...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC01Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c01_inner")]
    public partial class Af01PlDataC01Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC01Inner" /> class.
        /// </summary>
        ...
        /// <param name="e2010">Het administratienummer dat eerder aan de betrokken persoon is toegekend geweest. ⦿ Groep: A-nummerverwijzingen (20) ⦿ Element: Vorig A-nummer (20.10).</param>
        /// <param name="e2020">Het administratienummer dat nadien aan de betrokken persoon is toegekend. ⦿ Groep: A-nummerverwijzingen (20) ⦿ Element: Volgend A-nummer (20.20).</param>
        /// <param name="e6110">Een aanduiding voor de wijze van aanschrijving van de ingeschrevene. ⦿ Groep: Naamgebruik (61) ⦿ Element: Aanduiding naamgebruik (61.10).</param>
        ...
        public Af01PlDataC01Inner(string e0110 = default, string e0120 = default, string e0210 = default, string e0220 = default, string e0230 = default, string e0240 = default, string e0310 = default, string e0320 = default, string e0330 = default, string e0410 = default, string e2010 = default, string e2020 = default, string e6110 = default, string e8110 = default, string e8120 = default, string e8210 = default, string e8220 = default, string e8230 = default, string e8310 = default, string e8320 = default, string e8330 = default, string e8410 = default, string e8510 = default, string e8610 = default, string e8810 = default, string e8820 = default, List<Af01PlDataC01InnerAllOfHistorieInner> historie = default)
        {
            this.E0110 = e0110;
            this.E0120 = e0120;
            this.E0210 = e0210;
        ...
        /// <summary>
        /// Het administratienummer dat eerder aan de betrokken persoon is toegekend geweest. ⦿ Groep: A-nummerverwijzingen (20) ⦿ Element: Vorig A-nummer (20.10)
        /// </summary>
        /// <value>Het administratienummer dat eerder aan de betrokken persoon is toegekend geweest. ⦿ Groep: A-nummerverwijzingen (20) ⦿ Element: Vorig A-nummer (20.10)</value>
        [DataMember(Name = "e2010", EmitDefaultValue = false)]
        public string E2010 { get; set; }

        /// <summary>
        /// Het administratienummer dat nadien aan de betrokken persoon is toegekend. ⦿ Groep: A-nummerverwijzingen (20) ⦿ Element: Volgend A-nummer (20.20)
        /// </summary>
        /// <value>Het administratienummer dat nadien aan de betrokken persoon is toegekend. ⦿ Groep: A-nummerverwijzingen (20) ⦿ Element: Volgend A-nummer (20.20)</value>
        [DataMember(Name = "e2020", EmitDefaultValue = false)]
        public string E2020 { get; set; }

        /// <summary>
        /// Een aanduiding voor de wijze van aanschrijving van de ingeschrevene. ⦿ Groep: Naamgebruik (61) ⦿ Element: Aanduiding naamgebruik (61.10)
        /// </summary>
        /// <value>Een aanduiding voor de wijze van aanschrijving van de ingeschrevene. ⦿ Groep: Naamgebruik (61) ⦿ Element: Aanduiding naamgebruik (61.10)</value>
        [DataMember(Name = "e6110", EmitDefaultValue = false)]
        public string E6110 { get; set; }
        ...
        public List<Af01PlDataC01InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC01Inner {\n");
            ...
            sb.Append("  E2010: ").Append(E2010).Append("\n");
            sb.Append("  E2020: ").Append(E2020).Append("\n");
            sb.Append("  E6110: ").Append(E6110).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.E2010 != null) {
                // E2010 (string) pattern
                Regex regexE2010 = new Regex(@"^(|[0-9]{10})$", RegexOptions.CultureInvariant);
                if (!regexE2010.Match(this.E2010).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E2010, must match a pattern of " + regexE2010, new [] { "E2010" });
                }
            }

            if (this.E2020 != null) {
                // E2020 (string) pattern
                Regex regexE2020 = new Regex(@"^(|[0-9]{10})$", RegexOptions.CultureInvariant);
                if (!regexE2020.Match(this.E2020).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E2020, must match a pattern of " + regexE2020, new [] { "E2020" });
                }
            }

            // E6110 (string) maxLength
            if (this.E6110 != null && this.E6110.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E6110, length must be less than 1.", new [] { "E6110" });
            }

            // E6110 (string) minLength
            if (this.E6110 != null && this.E6110.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E6110, length must be greater than 0.", new [] { "E6110" });
            }
