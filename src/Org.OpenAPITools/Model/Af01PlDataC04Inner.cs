...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC04Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c04_inner")]
    public partial class Af01PlDataC04Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC04Inner" /> class.
        /// </summary>
        /// <param name="e0510">Een code, opgenomen in Tabel 32, Nationaliteitentabel, die aangeeft welke nationaliteit de ingeschrevene bezit. ⦿ Groep: Nationaliteit (05) ⦿ Element: Nationaliteit (05.10).</param>
        /// <param name="e6310">Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verkregen heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is opgenomen, dan wel dat het een persoon is waarop het bijzonder Nederlanderschap van toepassing is. ⦿ Groep: Opnemen nationaliteit (63) ⦿ Element: Reden opname nationaliteit (63.10).</param>
        /// <param name="e6410">Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verloren heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is beëindigd, dan wel dat voor een persoon het bijzonder Nederlanderschap niet langer van toepassing is. ⦿ Groep: Beëindigen nationaliteit (64) ⦿ Element: Reden beëindigen nationaliteit (64.10).</param>
        /// <param name="e6510">Een aanduiding die of aangeeft dat de ingeschrevene behandeld wordt als Nederlander, of dat door de rechter is vastgesteld dat de ingeschrevene niet de Nederlandse nationaliteit bezit. ⦿ Groep: Bijzonder Nederlanderschap (65) ⦿ Element: Aanduiding bijzonder Nederlanderschap (65.10).</param>
        /// <param name="e7310">Het persoonsnummer dat door een EU-land is afgegeven aan een onderdaan en dat van het overgelegde reisdocument is afgeleid. ⦿ Groep: Buitenlands persoonsnummer (73) ⦿ Element: EU-persoonsnummer (73.10).</param>
        ...
        public Af01PlDataC04Inner(string e0510 = default, string e6310 = default, string e6410 = default, string e6510 = default, string e7310 = default, string e8210 = default, string e8220 = default, string e8230 = default, string e8310 = default, string e8320 = default, string e8330 = default, string e8410 = default, string e8510 = default, string e8610 = default, string e8810 = default, string e8820 = default, List<Af01PlDataC04InnerAllOfHistorieInner> historie = default)
        {
            this.E0510 = e0510;
            this.E6310 = e6310;
            this.E6410 = e6410;
        ...
        /// <summary>
        /// Een code, opgenomen in Tabel 32, Nationaliteitentabel, die aangeeft welke nationaliteit de ingeschrevene bezit. ⦿ Groep: Nationaliteit (05) ⦿ Element: Nationaliteit (05.10)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 32, Nationaliteitentabel, die aangeeft welke nationaliteit de ingeschrevene bezit. ⦿ Groep: Nationaliteit (05) ⦿ Element: Nationaliteit (05.10)</value>
        [DataMember(Name = "e0510", EmitDefaultValue = false)]
        public string E0510 { get; set; }
        ...
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verkregen heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is opgenomen, dan wel dat het een persoon is waarop het bijzonder Nederlanderschap van toepassing is. ⦿ Groep: Opnemen nationaliteit (63) ⦿ Element: Reden opname nationaliteit (63.10)</value>
        [DataMember(Name = "e6310", EmitDefaultValue = false)]
        public string E6310 { get; set; }

        /// <summary>
        /// Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verloren heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is beëindigd, dan wel dat voor een persoon het bijzonder Nederlanderschap niet langer van toepassing is. ⦿ Groep: Beëindigen nationaliteit (64) ⦿ Element: Reden beëindigen nationaliteit (64.10)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verloren heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is beëindigd, dan wel dat voor een persoon het bijzonder Nederlanderschap niet langer van toepassing is. ⦿ Groep: Beëindigen nationaliteit (64) ⦿ Element: Reden beëindigen nationaliteit (64.10)</value>
        [DataMember(Name = "e6410", EmitDefaultValue = false)]
        public string E6410 { get; set; }

        /// <summary>
        /// Een aanduiding die of aangeeft dat de ingeschrevene behandeld wordt als Nederlander, of dat door de rechter is vastgesteld dat de ingeschrevene niet de Nederlandse nationaliteit bezit. ⦿ Groep: Bijzonder Nederlanderschap (65) ⦿ Element: Aanduiding bijzonder Nederlanderschap (65.10)
        /// </summary>
        /// <value>Een aanduiding die of aangeeft dat de ingeschrevene behandeld wordt als Nederlander, of dat door de rechter is vastgesteld dat de ingeschrevene niet de Nederlandse nationaliteit bezit. ⦿ Groep: Bijzonder Nederlanderschap (65) ⦿ Element: Aanduiding bijzonder Nederlanderschap (65.10)</value>
        [DataMember(Name = "e6510", EmitDefaultValue = false)]
        public string E6510 { get; set; }

        /// <summary>
        /// Het persoonsnummer dat door een EU-land is afgegeven aan een onderdaan en dat van het overgelegde reisdocument is afgeleid. ⦿ Groep: Buitenlands persoonsnummer (73) ⦿ Element: EU-persoonsnummer (73.10)
        /// </summary>
        /// <value>Het persoonsnummer dat door een EU-land is afgegeven aan een onderdaan en dat van het overgelegde reisdocument is afgeleid. ⦿ Groep: Buitenlands persoonsnummer (73) ⦿ Element: EU-persoonsnummer (73.10)</value>
        [DataMember(Name = "e7310", EmitDefaultValue = false)]
        public string E7310 { get; set; }
        ...
        public List<Af01PlDataC04InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC04Inner {\n");
            sb.Append("  E0510: ").Append(E0510).Append("\n");
            sb.Append("  E6310: ").Append(E6310).Append("\n");
            sb.Append("  E6410: ").Append(E6410).Append("\n");
            sb.Append("  E6510: ").Append(E6510).Append("\n");
            sb.Append("  E7310: ").Append(E7310).Append("\n");
        ...
        {
            // E0510 (string) maxLength
            if (this.E0510 != null && this.E0510.Length > 4)
            {
                yield return new ValidationResult("Invalid value for E0510, length must be less than 4.", new [] { "E0510" });
            }

            // E0510 (string) minLength
            if (this.E0510 != null && this.E0510.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E0510, length must be greater than 0.", new [] { "E0510" });
            }

            // E6310 (string) maxLength
            if (this.E6310 != null && this.E6310.Length > 3)
            {
                yield return new ValidationResult("Invalid value for E6310, length must be less than 3.", new [] { "E6310" });
            }

            // E6310 (string) minLength
            if (this.E6310 != null && this.E6310.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E6310, length must be greater than 0.", new [] { "E6310" });
            }

            // E6410 (string) maxLength
            if (this.E6410 != null && this.E6410.Length > 3)
            {
                yield return new ValidationResult("Invalid value for E6410, length must be less than 3.", new [] { "E6410" });
            }

            // E6410 (string) minLength
            if (this.E6410 != null && this.E6410.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E6410, length must be greater than 0.", new [] { "E6410" });
            }

            // E6510 (string) maxLength
            if (this.E6510 != null && this.E6510.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E6510, length must be less than 1.", new [] { "E6510" });
            }

            // E6510 (string) minLength
            if (this.E6510 != null && this.E6510.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E6510, length must be greater than 0.", new [] { "E6510" });
            }

            // E7310 (string) maxLength
            if (this.E7310 != null && this.E7310.Length > 40)
            {
                yield return new ValidationResult("Invalid value for E7310, length must be less than 40.", new [] { "E7310" });
            }

            // E7310 (string) minLength
            if (this.E7310 != null && this.E7310.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E7310, length must be greater than 0.", new [] { "E7310" });
            }
