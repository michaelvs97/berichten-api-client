...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC06Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c06_inner")]
    public partial class Af01PlDataC06Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC06Inner" /> class.
        /// </summary>
        /// <param name="e0810">De datum van overlijden. ⦿ Groep: Overlijden (08) ⦿ Element: Datum overlijden (08.10).</param>
        /// <param name="e0820">Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar het overlijden heeft plaatsgevonden. ⦿ Groep: Overlijden (08) ⦿ Element: Plaats overlijden (08.20).</param>
        /// <param name="e0830">Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar de persoon is overleden. ⦿ Groep: Overlijden (08) ⦿ Element: Land overlijden (08.30).</param>
        ...
        public Af01PlDataC06Inner(string e0810 = default, string e0820 = default, string e0830 = default, string e8110 = default, string e8120 = default, string e8210 = default, string e8220 = default, string e8230 = default, string e8310 = default, string e8320 = default, string e8330 = default, string e8410 = default, string e8510 = default, string e8610 = default, string e8810 = default, string e8820 = default, List<Af01PlDataC06InnerAllOfHistorieInner> historie = default)
        {
            this.E0810 = e0810;
            this.E0820 = e0820;
            this.E0830 = e0830;
        ...
        /// <summary>
        /// De datum van overlijden. ⦿ Groep: Overlijden (08) ⦿ Element: Datum overlijden (08.10)
        /// </summary>
        /// <value>De datum van overlijden. ⦿ Groep: Overlijden (08) ⦿ Element: Datum overlijden (08.10)</value>
        [DataMember(Name = "e0810", EmitDefaultValue = false)]
        public string E0810 { get; set; }

        /// <summary>
        /// Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar het overlijden heeft plaatsgevonden. ⦿ Groep: Overlijden (08) ⦿ Element: Plaats overlijden (08.20)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar het overlijden heeft plaatsgevonden. ⦿ Groep: Overlijden (08) ⦿ Element: Plaats overlijden (08.20)</value>
        [DataMember(Name = "e0820", EmitDefaultValue = false)]
        public string E0820 { get; set; }

        /// <summary>
        /// Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar de persoon is overleden. ⦿ Groep: Overlijden (08) ⦿ Element: Land overlijden (08.30)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar de persoon is overleden. ⦿ Groep: Overlijden (08) ⦿ Element: Land overlijden (08.30)</value>
        [DataMember(Name = "e0830", EmitDefaultValue = false)]
        public string E0830 { get; set; }
        ...
        public List<Af01PlDataC06InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC06Inner {\n");
            sb.Append("  E0810: ").Append(E0810).Append("\n");
            sb.Append("  E0820: ").Append(E0820).Append("\n");
            sb.Append("  E0830: ").Append(E0830).Append("\n");
        ...
        {
            if (this.E0810 != null) {
                // E0810 (string) pattern
                Regex regexE0810 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE0810.Match(this.E0810).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E0810, must match a pattern of " + regexE0810, new [] { "E0810" });
                }
            }

            // E0820 (string) maxLength
            if (this.E0820 != null && this.E0820.Length > 40)
            {
                yield return new ValidationResult("Invalid value for E0820, length must be less than 40.", new [] { "E0820" });
            }

            // E0820 (string) minLength
            if (this.E0820 != null && this.E0820.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E0820, length must be greater than 0.", new [] { "E0820" });
            }

            // E0830 (string) maxLength
            if (this.E0830 != null && this.E0830.Length > 4)
            {
                yield return new ValidationResult("Invalid value for E0830, length must be less than 4.", new [] { "E0830" });
            }

            // E0830 (string) minLength
            if (this.E0830 != null && this.E0830.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E0830, length must be greater than 0.", new [] { "E0830" });
            }
