...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC10Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c10_inner")]
    public partial class Af01PlDataC10Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC10Inner" /> class.
        /// </summary>
        /// <param name="e3910">Een code, opgenomen in Tabel 56, Verblijfstiteltabel, die aangeeft over welke verblijfsrechtelijke status de ingeschrevene beschikt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Aanduiding verblijfstitel (39.10).</param>
        /// <param name="e3920">De datum waarop de verblijfstitel zijn geldigheid verliest.  Dit element wordt uitsluitend opgenomen indien er sprake is van een verblijfstitel voor bepaalde tijd. Bij een verblijfstitel voor het leven komt het element niet voor. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Datum einde verblijfstitel (39.20).</param>
        /// <param name="e3930">De datum waarop de verblijfstitel zijn geldigheid krijgt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Ingangsdatum verblijfstitel (39.30).</param>
        ...
        public Af01PlDataC10Inner(string e3910 = default, string e3920 = default, string e3930 = default, string e8310 = default, string e8320 = default, string e8330 = default, string e8410 = default, string e8510 = default, string e8610 = default, List<Af01PlDataC10InnerAllOfHistorieInner> historie = default)
        {
            this.E3910 = e3910;
            this.E3920 = e3920;
            this.E3930 = e3930;
        ...
        /// <summary>
        /// Een code, opgenomen in Tabel 56, Verblijfstiteltabel, die aangeeft over welke verblijfsrechtelijke status de ingeschrevene beschikt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Aanduiding verblijfstitel (39.10)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 56, Verblijfstiteltabel, die aangeeft over welke verblijfsrechtelijke status de ingeschrevene beschikt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Aanduiding verblijfstitel (39.10)</value>
        [DataMember(Name = "e3910", EmitDefaultValue = false)]
        public string E3910 { get; set; }

        /// <summary>
        /// De datum waarop de verblijfstitel zijn geldigheid verliest.  Dit element wordt uitsluitend opgenomen indien er sprake is van een verblijfstitel voor bepaalde tijd. Bij een verblijfstitel voor het leven komt het element niet voor. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Datum einde verblijfstitel (39.20)
        /// </summary>
        /// <value>De datum waarop de verblijfstitel zijn geldigheid verliest.  Dit element wordt uitsluitend opgenomen indien er sprake is van een verblijfstitel voor bepaalde tijd. Bij een verblijfstitel voor het leven komt het element niet voor. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Datum einde verblijfstitel (39.20)</value>
        [DataMember(Name = "e3920", EmitDefaultValue = false)]
        public string E3920 { get; set; }

        /// <summary>
        /// De datum waarop de verblijfstitel zijn geldigheid krijgt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Ingangsdatum verblijfstitel (39.30)
        /// </summary>
        /// <value>De datum waarop de verblijfstitel zijn geldigheid krijgt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Ingangsdatum verblijfstitel (39.30)</value>
        [DataMember(Name = "e3930", EmitDefaultValue = false)]
        public string E3930 { get; set; }
        ...
        public List<Af01PlDataC10InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC10Inner {\n");
            sb.Append("  E3910: ").Append(E3910).Append("\n");
            sb.Append("  E3920: ").Append(E3920).Append("\n");
            sb.Append("  E3930: ").Append(E3930).Append("\n");
        ...
        {
            // E3910 (string) maxLength
            if (this.E3910 != null && this.E3910.Length > 2)
            {
                yield return new ValidationResult("Invalid value for E3910, length must be less than 2.", new [] { "E3910" });
            }

            // E3910 (string) minLength
            if (this.E3910 != null && this.E3910.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3910, length must be greater than 0.", new [] { "E3910" });
            }

            if (this.E3920 != null) {
                // E3920 (string) pattern
                Regex regexE3920 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3920.Match(this.E3920).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3920, must match a pattern of " + regexE3920, new [] { "E3920" });
                }
            }

            if (this.E3930 != null) {
                // E3930 (string) pattern
                Regex regexE3930 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3930.Match(this.E3930).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3930, must match a pattern of " + regexE3930, new [] { "E3930" });
                }
            }
