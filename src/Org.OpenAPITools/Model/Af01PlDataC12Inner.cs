...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC12Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c12_inner")]
    public partial class Af01PlDataC12Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC12Inner" /> class.
        /// </summary>
        /// <param name="e3510">Een codering, opgenomen in Tabel 48, Tabel Nederlands reisdocument, die aangeeft welk Nederlands reisdocument is verstrekt of in welk reisdocument de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Soort Nederlands reisdocument (35.10).</param>
        /// <param name="e3520">Het nummer van het verstrekte Nederlandse reisdocument of het nummer van het Nederlandse reisdocument waarin de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Nummer Nederlands reisdocument (35.20).</param>
        /// <param name="e3530">De datum waarop het Nederlands reisdocument is uitgegeven of de datum van bijschrijving van de ingeschrevene in een Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum uitgifte Nederlands reisdocument (35.30).</param>
        /// <param name="e3540">Een codering, opgenomen in Tabel 49, Tabel Autoriteit van afgifte Nederlands reisdocument, die aangeeft welke autoriteit het Nederlands reisdocument heeft verstrekt of de bijschrijving heeft verricht. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Autoriteit van afgifte Nederlands reisdocument (35.40).</param>
        /// <param name="e3550">De datum waarop een Nederlands reisdocument, dat aan de ingeschrevene is verstrekt of waarin de ingeschrevene is bijgeschreven, zijn geldigheid verliest. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum einde geldigheid Nederlands reisdocument (35.50).</param>
        /// <param name="e3560">De datum waarop een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum inhouding dan wel vermissing Nederlands reisdocument (35.60).</param>
        /// <param name="e3570">Een aanduiding dat een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Aanduiding inhouding dan wel vermissing Nederlands reisdocument (35.70).</param>
        /// <param name="e3580">De lengte van de ingeschrevene in hele centimeters zoals vermeld in het Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Lengte van de houder van het Nederlands reisdocument (35.80).</param>
        /// <param name="e3610">Een aanduiding dat aan de ingeschrevene geen reisdocument mag worden verstrekt. ⦿ Groep: Signalering (36) ⦿ Element: Signalering met betrekking tot verstrekken Nederlands reisdocument (36.10).</param>
        /// <param name="e3710">Een aanduiding dat de ingeschrevene beschikt over één of meer buitenlandse reisdocumenten. ⦿ Groep: Buitenlands reisdocument (37) ⦿ Element: Aanduiding dat de ingeschrevene beschikt over één of meer buitenlandse reisdocumenten (37.10).</param>
        ...
        public Af01PlDataC12Inner(string e3510 = default, string e3520 = default, string e3530 = default, string e3540 = default, string e3550 = default, string e3560 = default, string e3570 = default, string e3580 = default, string e3610 = default, string e3710 = default, string e8210 = default, string e8220 = default, string e8230 = default, string e8310 = default, string e8320 = default, string e8330 = default, string e8510 = default, string e8610 = default, List<Af01PlDataC12InnerAllOfHistorieInner> historie = default)
        {
            this.E3510 = e3510;
            this.E3520 = e3520;
            this.E3530 = e3530;
        ...
        /// <summary>
        /// Een codering, opgenomen in Tabel 48, Tabel Nederlands reisdocument, die aangeeft welk Nederlands reisdocument is verstrekt of in welk reisdocument de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Soort Nederlands reisdocument (35.10)
        /// </summary>
        /// <value>Een codering, opgenomen in Tabel 48, Tabel Nederlands reisdocument, die aangeeft welk Nederlands reisdocument is verstrekt of in welk reisdocument de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Soort Nederlands reisdocument (35.10)</value>
        [DataMember(Name = "e3510", EmitDefaultValue = false)]
        public string E3510 { get; set; }

        /// <summary>
        /// Het nummer van het verstrekte Nederlandse reisdocument of het nummer van het Nederlandse reisdocument waarin de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Nummer Nederlands reisdocument (35.20)
        /// </summary>
        /// <value>Het nummer van het verstrekte Nederlandse reisdocument of het nummer van het Nederlandse reisdocument waarin de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Nummer Nederlands reisdocument (35.20)</value>
        [DataMember(Name = "e3520", EmitDefaultValue = false)]
        public string E3520 { get; set; }

        /// <summary>
        /// De datum waarop het Nederlands reisdocument is uitgegeven of de datum van bijschrijving van de ingeschrevene in een Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum uitgifte Nederlands reisdocument (35.30)
        /// </summary>
        /// <value>De datum waarop het Nederlands reisdocument is uitgegeven of de datum van bijschrijving van de ingeschrevene in een Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum uitgifte Nederlands reisdocument (35.30)</value>
        [DataMember(Name = "e3530", EmitDefaultValue = false)]
        public string E3530 { get; set; }

        /// <summary>
        /// Een codering, opgenomen in Tabel 49, Tabel Autoriteit van afgifte Nederlands reisdocument, die aangeeft welke autoriteit het Nederlands reisdocument heeft verstrekt of de bijschrijving heeft verricht. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Autoriteit van afgifte Nederlands reisdocument (35.40)
        /// </summary>
        /// <value>Een codering, opgenomen in Tabel 49, Tabel Autoriteit van afgifte Nederlands reisdocument, die aangeeft welke autoriteit het Nederlands reisdocument heeft verstrekt of de bijschrijving heeft verricht. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Autoriteit van afgifte Nederlands reisdocument (35.40)</value>
        [DataMember(Name = "e3540", EmitDefaultValue = false)]
        public string E3540 { get; set; }

        /// <summary>
        /// De datum waarop een Nederlands reisdocument, dat aan de ingeschrevene is verstrekt of waarin de ingeschrevene is bijgeschreven, zijn geldigheid verliest. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum einde geldigheid Nederlands reisdocument (35.50)
        /// </summary>
        /// <value>De datum waarop een Nederlands reisdocument, dat aan de ingeschrevene is verstrekt of waarin de ingeschrevene is bijgeschreven, zijn geldigheid verliest. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum einde geldigheid Nederlands reisdocument (35.50)</value>
        [DataMember(Name = "e3550", EmitDefaultValue = false)]
        public string E3550 { get; set; }

        /// <summary>
        /// De datum waarop een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum inhouding dan wel vermissing Nederlands reisdocument (35.60)
        /// </summary>
        /// <value>De datum waarop een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum inhouding dan wel vermissing Nederlands reisdocument (35.60)</value>
        [DataMember(Name = "e3560", EmitDefaultValue = false)]
        public string E3560 { get; set; }

        /// <summary>
        /// Een aanduiding dat een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Aanduiding inhouding dan wel vermissing Nederlands reisdocument (35.70)
        /// </summary>
        /// <value>Een aanduiding dat een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Aanduiding inhouding dan wel vermissing Nederlands reisdocument (35.70)</value>
        [DataMember(Name = "e3570", EmitDefaultValue = false)]
        public string E3570 { get; set; }

        /// <summary>
        /// De lengte van de ingeschrevene in hele centimeters zoals vermeld in het Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Lengte van de houder van het Nederlands reisdocument (35.80)
        /// </summary>
        /// <value>De lengte van de ingeschrevene in hele centimeters zoals vermeld in het Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Lengte van de houder van het Nederlands reisdocument (35.80)</value>
        [DataMember(Name = "e3580", EmitDefaultValue = false)]
        [Obsolete]
        public string E3580 { get; set; }

        /// <summary>
        /// Een aanduiding dat aan de ingeschrevene geen reisdocument mag worden verstrekt. ⦿ Groep: Signalering (36) ⦿ Element: Signalering met betrekking tot verstrekken Nederlands reisdocument (36.10)
        /// </summary>
        /// <value>Een aanduiding dat aan de ingeschrevene geen reisdocument mag worden verstrekt. ⦿ Groep: Signalering (36) ⦿ Element: Signalering met betrekking tot verstrekken Nederlands reisdocument (36.10)</value>
        [DataMember(Name = "e3610", EmitDefaultValue = false)]
        public string E3610 { get; set; }

        /// <summary>
        /// Een aanduiding dat de ingeschrevene beschikt over één of meer buitenlandse reisdocumenten. ⦿ Groep: Buitenlands reisdocument (37) ⦿ Element: Aanduiding dat de ingeschrevene beschikt over één of meer buitenlandse reisdocumenten (37.10)
        /// </summary>
        /// <value>Een aanduiding dat de ingeschrevene beschikt over één of meer buitenlandse reisdocumenten. ⦿ Groep: Buitenlands reisdocument (37) ⦿ Element: Aanduiding dat de ingeschrevene beschikt over één of meer buitenlandse reisdocumenten (37.10)</value>
        [DataMember(Name = "e3710", EmitDefaultValue = false)]
        [Obsolete]
        public string E3710 { get; set; }
        ...
        public List<Af01PlDataC12InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC12Inner {\n");
            sb.Append("  E3510: ").Append(E3510).Append("\n");
            sb.Append("  E3520: ").Append(E3520).Append("\n");
            sb.Append("  E3530: ").Append(E3530).Append("\n");
            sb.Append("  E3540: ").Append(E3540).Append("\n");
            sb.Append("  E3550: ").Append(E3550).Append("\n");
            sb.Append("  E3560: ").Append(E3560).Append("\n");
            sb.Append("  E3570: ").Append(E3570).Append("\n");
            sb.Append("  E3580: ").Append(E3580).Append("\n");
            sb.Append("  E3610: ").Append(E3610).Append("\n");
            sb.Append("  E3710: ").Append(E3710).Append("\n");
        ...
        {
            // E3510 (string) maxLength
            if (this.E3510 != null && this.E3510.Length > 2)
            {
                yield return new ValidationResult("Invalid value for E3510, length must be less than 2.", new [] { "E3510" });
            }

            // E3510 (string) minLength
            if (this.E3510 != null && this.E3510.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3510, length must be greater than 0.", new [] { "E3510" });
            }

            // E3520 (string) maxLength
            if (this.E3520 != null && this.E3520.Length > 9)
            {
                yield return new ValidationResult("Invalid value for E3520, length must be less than 9.", new [] { "E3520" });
            }

            // E3520 (string) minLength
            if (this.E3520 != null && this.E3520.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3520, length must be greater than 0.", new [] { "E3520" });
            }

            if (this.E3530 != null) {
                // E3530 (string) pattern
                Regex regexE3530 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3530.Match(this.E3530).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3530, must match a pattern of " + regexE3530, new [] { "E3530" });
                }
            }

            // E3540 (string) maxLength
            if (this.E3540 != null && this.E3540.Length > 6)
            {
                yield return new ValidationResult("Invalid value for E3540, length must be less than 6.", new [] { "E3540" });
            }

            // E3540 (string) minLength
            if (this.E3540 != null && this.E3540.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3540, length must be greater than 0.", new [] { "E3540" });
            }

            if (this.E3550 != null) {
                // E3550 (string) pattern
                Regex regexE3550 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3550.Match(this.E3550).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3550, must match a pattern of " + regexE3550, new [] { "E3550" });
                }
            }

            if (this.E3560 != null) {
                // E3560 (string) pattern
                Regex regexE3560 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3560.Match(this.E3560).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3560, must match a pattern of " + regexE3560, new [] { "E3560" });
                }
            }

            // E3570 (string) maxLength
            if (this.E3570 != null && this.E3570.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E3570, length must be less than 1.", new [] { "E3570" });
            }

            // E3570 (string) minLength
            if (this.E3570 != null && this.E3570.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3570, length must be greater than 0.", new [] { "E3570" });
            }

            // E3580 (string) maxLength
            if (this.E3580 != null && this.E3580.Length > 3)
            {
                yield return new ValidationResult("Invalid value for E3580, length must be less than 3.", new [] { "E3580" });
            }

            // E3580 (string) minLength
            if (this.E3580 != null && this.E3580.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3580, length must be greater than 0.", new [] { "E3580" });
            }

            // E3610 (string) maxLength
            if (this.E3610 != null && this.E3610.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E3610, length must be less than 1.", new [] { "E3610" });
            }

            // E3610 (string) minLength
            if (this.E3610 != null && this.E3610.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3610, length must be greater than 0.", new [] { "E3610" });
            }

            // E3710 (string) maxLength
            if (this.E3710 != null && this.E3710.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E3710, length must be less than 1.", new [] { "E3710" });
            }

            // E3710 (string) minLength
            if (this.E3710 != null && this.E3710.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3710, length must be greater than 0.", new [] { "E3710" });
            }
