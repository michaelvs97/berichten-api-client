...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC13Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c13_inner")]
    public partial class Af01PlDataC13Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC13Inner" /> class.
        /// </summary>
        /// <param name="e3110">Een aanduiding die aangeeft of de persoon een oproep moet ontvangen voor verkiezingen voor het Europees parlement. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Aanduiding Europees kiesrecht (31.10).</param>
        /// <param name="e3120">De datum waarop de persoon een verzoek heeft gedaan met betrekking tot het uitoefenen van zijn kiesrecht voor het Europees parlement of de datum waarop de gemeente een melding heeft ontvangen dat de persoon is uitgesloten van deelname aan verkiezingen voor het Europees parlement. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Datum verzoek of mededeling Europees kiesrecht (31.20).</param>
        /// <param name="e3130">De datum waarop een uitsluiting voor deelname aan verkiezingen voor het Europees parlement niet meer van toepassing is.  Dit element wordt uitsluitend opgenomen indien er sprake is van een uitsluiting voor bepaalde tijd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Einddatum uitsluiting Europees kiesrecht (31.30).</param>
        /// <param name="e3140">Het adres (zonder de plaatsnaam) in de EU-lidstaat waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Adres EU-lidstaat van herkomst (31.40).</param>
        /// <param name="e3150">Plaatsnaam in de EU-lidstaat waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Plaats EU-lidstaat van herkomst (31.50).</param>
        /// <param name="e3160">Een code, opgenomen in Tabel 34, Landentabel, dat het land (de EU-lidstaat) aangeeft waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Land EU-lidstaat van herkomst (31.60).</param>
        /// <param name="e3810">Een aanduiding ter uitvoering van de Kieswet. ⦿ Groep: Uitsluiting kiesrecht (38) ⦿ Element: Aanduiding uitgesloten kiesrecht (38.10).</param>
        /// <param name="e3820">De datum waarop een uitsluiting kiesrecht niet meer van toepassing is. Dit element wordt uitsluitend opgenomen indien er sprake is van een uitsluiting voor bepaalde tijd. Bij een uitsluiting voor het leven komt het element niet voor. ⦿ Groep: Uitsluiting kiesrecht (38) ⦿ Element: Einddatum uitsluiting kiesrecht (38.20).</param>
        ...
        public Af01PlDataC13Inner(string e3110 = default, string e3120 = default, string e3130 = default, string e3140 = default, string e3150 = default, string e3160 = default, string e3810 = default, string e3820 = default, string e8210 = default, string e8220 = default, string e8230 = default, List<Af01PlDataC13InnerAllOfHistorieInner> historie = default)
        {
            this.E3110 = e3110;
            this.E3120 = e3120;
            this.E3130 = e3130;
        ...
        /// <summary>
        /// Een aanduiding die aangeeft of de persoon een oproep moet ontvangen voor verkiezingen voor het Europees parlement. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Aanduiding Europees kiesrecht (31.10)
        /// </summary>
        /// <value>Een aanduiding die aangeeft of de persoon een oproep moet ontvangen voor verkiezingen voor het Europees parlement. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Aanduiding Europees kiesrecht (31.10)</value>
        [DataMember(Name = "e3110", EmitDefaultValue = false)]
        public string E3110 { get; set; }

        /// <summary>
        /// De datum waarop de persoon een verzoek heeft gedaan met betrekking tot het uitoefenen van zijn kiesrecht voor het Europees parlement of de datum waarop de gemeente een melding heeft ontvangen dat de persoon is uitgesloten van deelname aan verkiezingen voor het Europees parlement. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Datum verzoek of mededeling Europees kiesrecht (31.20)
        /// </summary>
        /// <value>De datum waarop de persoon een verzoek heeft gedaan met betrekking tot het uitoefenen van zijn kiesrecht voor het Europees parlement of de datum waarop de gemeente een melding heeft ontvangen dat de persoon is uitgesloten van deelname aan verkiezingen voor het Europees parlement. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Datum verzoek of mededeling Europees kiesrecht (31.20)</value>
        [DataMember(Name = "e3120", EmitDefaultValue = false)]
        public string E3120 { get; set; }

        /// <summary>
        /// De datum waarop een uitsluiting voor deelname aan verkiezingen voor het Europees parlement niet meer van toepassing is.  Dit element wordt uitsluitend opgenomen indien er sprake is van een uitsluiting voor bepaalde tijd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Einddatum uitsluiting Europees kiesrecht (31.30)
        /// </summary>
        /// <value>De datum waarop een uitsluiting voor deelname aan verkiezingen voor het Europees parlement niet meer van toepassing is.  Dit element wordt uitsluitend opgenomen indien er sprake is van een uitsluiting voor bepaalde tijd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Einddatum uitsluiting Europees kiesrecht (31.30)</value>
        [DataMember(Name = "e3130", EmitDefaultValue = false)]
        public string E3130 { get; set; }

        /// <summary>
        /// Het adres (zonder de plaatsnaam) in de EU-lidstaat waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Adres EU-lidstaat van herkomst (31.40)
        /// </summary>
        /// <value>Het adres (zonder de plaatsnaam) in de EU-lidstaat waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Adres EU-lidstaat van herkomst (31.40)</value>
        [DataMember(Name = "e3140", EmitDefaultValue = false)]
        public string E3140 { get; set; }

        /// <summary>
        /// Plaatsnaam in de EU-lidstaat waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Plaats EU-lidstaat van herkomst (31.50)
        /// </summary>
        /// <value>Plaatsnaam in de EU-lidstaat waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Plaats EU-lidstaat van herkomst (31.50)</value>
        [DataMember(Name = "e3150", EmitDefaultValue = false)]
        public string E3150 { get; set; }

        /// <summary>
        /// Een code, opgenomen in Tabel 34, Landentabel, dat het land (de EU-lidstaat) aangeeft waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Land EU-lidstaat van herkomst (31.60)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 34, Landentabel, dat het land (de EU-lidstaat) aangeeft waarvan de ingeschrevene de nationaliteit bezit en waar de ingeschrevene het laatst als kiezer was geregistreerd. ⦿ Groep: Europees kiesrecht (31) ⦿ Element: Land EU-lidstaat van herkomst (31.60)</value>
        [DataMember(Name = "e3160", EmitDefaultValue = false)]
        public string E3160 { get; set; }

        /// <summary>
        /// Een aanduiding ter uitvoering van de Kieswet. ⦿ Groep: Uitsluiting kiesrecht (38) ⦿ Element: Aanduiding uitgesloten kiesrecht (38.10)
        /// </summary>
        /// <value>Een aanduiding ter uitvoering van de Kieswet. ⦿ Groep: Uitsluiting kiesrecht (38) ⦿ Element: Aanduiding uitgesloten kiesrecht (38.10)</value>
        [DataMember(Name = "e3810", EmitDefaultValue = false)]
        public string E3810 { get; set; }
        ...
        /// </summary>
        /// <value>De datum waarop een uitsluiting kiesrecht niet meer van toepassing is. Dit element wordt uitsluitend opgenomen indien er sprake is van een uitsluiting voor bepaalde tijd. Bij een uitsluiting voor het leven komt het element niet voor. ⦿ Groep: Uitsluiting kiesrecht (38) ⦿ Element: Einddatum uitsluiting kiesrecht (38.20)</value>
        [DataMember(Name = "e3820", EmitDefaultValue = false)]
        public string E3820 { get; set; }
        ...
        public List<Af01PlDataC13InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC13Inner {\n");
            sb.Append("  E3110: ").Append(E3110).Append("\n");
            sb.Append("  E3120: ").Append(E3120).Append("\n");
            sb.Append("  E3130: ").Append(E3130).Append("\n");
            sb.Append("  E3140: ").Append(E3140).Append("\n");
            sb.Append("  E3150: ").Append(E3150).Append("\n");
            sb.Append("  E3160: ").Append(E3160).Append("\n");
            sb.Append("  E3810: ").Append(E3810).Append("\n");
            sb.Append("  E3820: ").Append(E3820).Append("\n");
        ...
        {
            // E3110 (string) maxLength
            if (this.E3110 != null && this.E3110.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E3110, length must be less than 1.", new [] { "E3110" });
            }

            // E3110 (string) minLength
            if (this.E3110 != null && this.E3110.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3110, length must be greater than 0.", new [] { "E3110" });
            }

            if (this.E3120 != null) {
                // E3120 (string) pattern
                Regex regexE3120 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3120.Match(this.E3120).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3120, must match a pattern of " + regexE3120, new [] { "E3120" });
                }
            }

            if (this.E3130 != null) {
                // E3130 (string) pattern
                Regex regexE3130 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3130.Match(this.E3130).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3130, must match a pattern of " + regexE3130, new [] { "E3130" });
                }
            }

            // E3140 (string) maxLength
            if (this.E3140 != null && this.E3140.Length > 50)
            {
                yield return new ValidationResult("Invalid value for E3140, length must be less than 50.", new [] { "E3140" });
            }

            // E3140 (string) minLength
            if (this.E3140 != null && this.E3140.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3140, length must be greater than 0.", new [] { "E3140" });
            }

            // E3150 (string) maxLength
            if (this.E3150 != null && this.E3150.Length > 50)
            {
                yield return new ValidationResult("Invalid value for E3150, length must be less than 50.", new [] { "E3150" });
            }

            // E3150 (string) minLength
            if (this.E3150 != null && this.E3150.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3150, length must be greater than 0.", new [] { "E3150" });
            }

            // E3160 (string) maxLength
            if (this.E3160 != null && this.E3160.Length > 4)
            {
                yield return new ValidationResult("Invalid value for E3160, length must be less than 4.", new [] { "E3160" });
            }

            // E3160 (string) minLength
            if (this.E3160 != null && this.E3160.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3160, length must be greater than 0.", new [] { "E3160" });
            }

            // E3810 (string) maxLength
            if (this.E3810 != null && this.E3810.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E3810, length must be less than 1.", new [] { "E3810" });
            }

            // E3810 (string) minLength
            if (this.E3810 != null && this.E3810.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E3810, length must be greater than 0.", new [] { "E3810" });
            }

            if (this.E3820 != null) {
                // E3820 (string) pattern
                Regex regexE3820 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE3820.Match(this.E3820).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E3820, must match a pattern of " + regexE3820, new [] { "E3820" });
                }
            }
