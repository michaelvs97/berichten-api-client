...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC14Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c14_inner")]
    public partial class Af01PlDataC14Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC14Inner" /> class.
        /// </summary>
        /// <param name="e4010">Een code, opgenomen in Tabel 35, Autorisatietabel, die het nummer aangeeft dat door RvIG wordt toegekend aan een geautoriseerde afnemer of derde die recht heeft op verstrekking van spontane mutaties. ⦿ Groep: Afnemer (40) ⦿ Element: Afnemersindicatie (40.10).</param>
        ...
        public Af01PlDataC14Inner(string e4010 = default, string e8510 = default, List<Af01PlDataC14InnerAllOfHistorieInner> historie = default)
        {
            this.E4010 = e4010;
            this.E8510 = e8510;
        ...
        /// <summary>
        /// Een code, opgenomen in Tabel 35, Autorisatietabel, die het nummer aangeeft dat door RvIG wordt toegekend aan een geautoriseerde afnemer of derde die recht heeft op verstrekking van spontane mutaties. ⦿ Groep: Afnemer (40) ⦿ Element: Afnemersindicatie (40.10)
        /// </summary>
        /// <value>Een code, opgenomen in Tabel 35, Autorisatietabel, die het nummer aangeeft dat door RvIG wordt toegekend aan een geautoriseerde afnemer of derde die recht heeft op verstrekking van spontane mutaties. ⦿ Groep: Afnemer (40) ⦿ Element: Afnemersindicatie (40.10)</value>
        [DataMember(Name = "e4010", EmitDefaultValue = false)]
        public string E4010 { get; set; }
        ...
        public List<Af01PlDataC14InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC14Inner {\n");
            sb.Append("  E4010: ").Append(E4010).Append("\n");
        ...
        {
            // E4010 (string) maxLength
            if (this.E4010 != null && this.E4010.Length > 6)
            {
                yield return new ValidationResult("Invalid value for E4010, length must be less than 6.", new [] { "E4010" });
            }

            // E4010 (string) minLength
            if (this.E4010 != null && this.E4010.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E4010, length must be greater than 0.", new [] { "E4010" });
            }
