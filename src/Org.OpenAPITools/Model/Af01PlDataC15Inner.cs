...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC15Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c15_inner")]
    public partial class Af01PlDataC15Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC15Inner" /> class.
        /// </summary>
        /// <param name="e4210">Een uit vak 6 of vak 23 van de PK afkomstige afnemersaantekening. ⦿ Groep: Aantekening (42) ⦿ Element: Aantekening (42.10).</param>
        /// <param name="historie">historie.</param>
        public Af01PlDataC15Inner(string e4210 = default, List<Af01PlDataC15InnerAllOfHistorieInner> historie = default)
        {
            this.E4210 = e4210;
        ...
        /// <summary>
        /// Een uit vak 6 of vak 23 van de PK afkomstige afnemersaantekening. ⦿ Groep: Aantekening (42) ⦿ Element: Aantekening (42.10)
        /// </summary>
        /// <value>Een uit vak 6 of vak 23 van de PK afkomstige afnemersaantekening. ⦿ Groep: Aantekening (42) ⦿ Element: Aantekening (42.10)</value>
        [DataMember(Name = "e4210", EmitDefaultValue = false)]
        [Obsolete]
        public string E4210 { get; set; }

        /// <summary>
        /// Gets or Sets Historie
        /// </summary>
        [DataMember(Name = "historie", EmitDefaultValue = false)]
        public List<Af01PlDataC15InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC15Inner {\n");
            sb.Append("  E4210: ").Append(E4210).Append("\n");
        ...
        {
            // E4210 (string) maxLength
            if (this.E4210 != null && this.E4210.Length > 24)
            {
                yield return new ValidationResult("Invalid value for E4210, length must be less than 24.", new [] { "E4210" });
            }

            // E4210 (string) minLength
            if (this.E4210 != null && this.E4210.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E4210, length must be greater than 0.", new [] { "E4210" });
            }
