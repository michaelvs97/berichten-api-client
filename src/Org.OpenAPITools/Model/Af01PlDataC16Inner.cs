...
namespace Org.OpenAPITools.Model
{
    ...
    /// Af01PlDataC16Inner
    /// </summary>
    [DataContract(Name = "Af01_plData_c16_inner")]
    public partial class Af01PlDataC16Inner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Af01PlDataC16Inner" /> class.
        /// </summary>
        ...
        /// <param name="e1810">De datum waarop betrokkene niet meer zijn tijdelijk verblijfsadres op dit adres houdt. ⦿ Groep: Einde geldigheid (18) ⦿ Element: Einddatum geldigheid (18.10).</param>
        /// <param name="e1910">Beschrijving wat de relatie van de betrokken persoon met dit adres. ⦿ Groep: Type adres (19) ⦿ Element: Type adres (19.10).</param>
        ...
        public Af01PlDataC16Inner(string e0910 = default, string e0920 = default, string e1110 = default, string e1115 = default, string e1120 = default, string e1130 = default, string e1140 = default, string e1150 = default, string e1160 = default, string e1170 = default, string e1180 = default, string e1190 = default, string e1810 = default, string e1910 = default, string e7210 = default, string e8310 = default, string e8320 = default, string e8330 = default, string e8410 = default, string e8510 = default, string e8610 = default, string e8810 = default, string e8820 = default, List<Af01PlDataC16InnerAllOfHistorieInner> historie = default)
        {
            this.E0910 = e0910;
            this.E0920 = e0920;
            this.E1110 = e1110;
        ...
        /// <summary>
        /// De datum waarop betrokkene niet meer zijn tijdelijk verblijfsadres op dit adres houdt. ⦿ Groep: Einde geldigheid (18) ⦿ Element: Einddatum geldigheid (18.10)
        /// </summary>
        /// <value>De datum waarop betrokkene niet meer zijn tijdelijk verblijfsadres op dit adres houdt. ⦿ Groep: Einde geldigheid (18) ⦿ Element: Einddatum geldigheid (18.10)</value>
        [DataMember(Name = "e1810", EmitDefaultValue = false)]
        public string E1810 { get; set; }

        /// <summary>
        /// Beschrijving wat de relatie van de betrokken persoon met dit adres. ⦿ Groep: Type adres (19) ⦿ Element: Type adres (19.10)
        /// </summary>
        /// <value>Beschrijving wat de relatie van de betrokken persoon met dit adres. ⦿ Groep: Type adres (19) ⦿ Element: Type adres (19.10)</value>
        [DataMember(Name = "e1910", EmitDefaultValue = false)]
        public string E1910 { get; set; }
        ...
        public List<Af01PlDataC16InnerAllOfHistorieInner> Historie { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Af01PlDataC16Inner {\n");
            ...
            sb.Append("  E1810: ").Append(E1810).Append("\n");
            sb.Append("  E1910: ").Append(E1910).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.E1810 != null) {
                // E1810 (string) pattern
                Regex regexE1810 = new Regex(@"^(|[0-9]{8})$", RegexOptions.CultureInvariant);
                if (!regexE1810.Match(this.E1810).Success)
                {
                    yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for E1810, must match a pattern of " + regexE1810, new [] { "E1810" });
                }
            }

            // E1910 (string) maxLength
            if (this.E1910 != null && this.E1910.Length > 1)
            {
                yield return new ValidationResult("Invalid value for E1910, length must be less than 1.", new [] { "E1910" });
            }

            // E1910 (string) minLength
            if (this.E1910 != null && this.E1910.Length < 0)
            {
                yield return new ValidationResult("Invalid value for E1910, length must be greater than 0.", new [] { "E1910" });
            }
