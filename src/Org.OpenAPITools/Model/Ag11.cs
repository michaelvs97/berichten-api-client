...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Ag11")]
    public partial class Ag11 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ag11" /> class.
        /// </summary>
        ...
        public Ag11(string schema = default, string berichtType = default, string status = default, string datum = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Ag11 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for Ag11 and cannot be null");
            }
            this.Status = status;
            // to ensure "datum" is required (not null)
            if (datum == null)
            {
                throw new ArgumentNullException("datum is a required property for Ag11 and cannot be null");
            }
            this.Datum = datum;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Ag11 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
