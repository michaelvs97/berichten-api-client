...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-AUTH-F001")]
    public partial class BBAAUTHF001 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAAUTHF001" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAAUTHF001() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAAUTHF001" /> class.
        /// </summary>
        /// <param name="title">Authenticatiefout (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F001 (required).</param>
        /// <param name="detail">Onjuiste of onbekende authenticatie. (required).</param>
        /// <param name="status">401 (required).</param>
        ...
        public BBAAUTHF001(string title = default, string type = default, string detail = default, int status = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAAUTHF001 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAAUTHF001 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAAUTHF001 and cannot be null");
            }
            this.Detail = detail;
            this.Status = status;
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F001</value>
        ...
        /// Onjuiste of onbekende authenticatie.
        /// </summary>
        /// <value>Onjuiste of onbekende authenticatie.</value>
