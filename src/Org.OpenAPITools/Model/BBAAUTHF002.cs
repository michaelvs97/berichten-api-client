...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-AUTH-F002")]
    public partial class BBAAUTHF002 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAAUTHF002" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAAUTHF002() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAAUTHF002" /> class.
        /// </summary>
        /// <param name="title">Authenticatiefout (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F002 (required).</param>
        /// <param name="detail">Het account is geblokkeerd. (required).</param>
        ...
        public BBAAUTHF002(string title = default, string type = default, string detail = default, int status = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAAUTHF002 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAAUTHF002 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAAUTHF002 and cannot be null");
            }
            this.Detail = detail;
            this.Status = status;
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F002</value>
        ...
        /// Het account is geblokkeerd.
        /// </summary>
        /// <value>Het account is geblokkeerd.</value>
