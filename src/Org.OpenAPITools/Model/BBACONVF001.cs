...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-CONV-F001")]
    public partial class BBACONVF001 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF001" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBACONVF001() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF001" /> class.
        /// </summary>
        /// <param name="title">Bronformaat en doelformaat zijn gelijk aan elkaar (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F001 (required).</param>
        /// <param name="detail">bronformaat &#39;[bronformaat]&#39; is gelijk aan doelformaat &#39;[doelformaat]&#39; (required).</param>
        /// <param name="invalidParameters">invalidParameters (required).</param>
        ...
        public BBACONVF001(string title = default, string type = default, string detail = default, List<InvalidParametersInner> invalidParameters = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBACONVF001 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBACONVF001 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBACONVF001 and cannot be null");
            }
            this.Detail = detail;
            // to ensure "invalidParameters" is required (not null)
            if (invalidParameters == null)
            {
                throw new ArgumentNullException("invalidParameters is a required property for BBACONVF001 and cannot be null");
            }
        ...
        /// Bronformaat en doelformaat zijn gelijk aan elkaar
        /// </summary>
        /// <value>Bronformaat en doelformaat zijn gelijk aan elkaar</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F001</value>
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public string Type { get; set; }

        /// <summary>
        /// bronformaat &#39;[bronformaat]&#39; is gelijk aan doelformaat &#39;[doelformaat]&#39;
        /// </summary>
        /// <value>bronformaat &#39;[bronformaat]&#39; is gelijk aan doelformaat &#39;[doelformaat]&#39;</value>
        ...
        /// </summary>
        [DataMember(Name = "invalidParameters", IsRequired = true, EmitDefaultValue = true)]
