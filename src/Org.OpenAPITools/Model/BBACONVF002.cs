...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-CONV-F002")]
    public partial class BBACONVF002 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF002" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBACONVF002() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF002" /> class.
        /// </summary>
        /// <param name="title">Content-Type header niet aanwezig (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F002 (required).</param>
        /// <param name="detail">Er is geen &#39;Content-Type:&#39; header meegegeven waardoor niet bepaald kon worden welk bron formaat er geleverd is. (required).</param>
        ...
        public BBACONVF002(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBACONVF002 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBACONVF002 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBACONVF002 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// Content-Type header niet aanwezig
        /// </summary>
        /// <value>Content-Type header niet aanwezig</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F002</value>
        ...
        /// </summary>
        /// <value>Er is geen &#39;Content-Type:&#39; header meegegeven waardoor niet bepaald kon worden welk bron formaat er geleverd is.</value>
