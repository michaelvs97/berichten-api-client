...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-CONV-F003")]
    public partial class BBACONVF003 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF003" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBACONVF003() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF003" /> class.
        /// </summary>
        /// <param name="title">Ongeldig bronformaat aangevraagd in &#39;Content-Type&#39; header (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F003 (required).</param>
        /// <param name="detail">Kon bronformaat niet bepalen a.d.h.v. Content-type header [content-type]. (required).</param>
        ...
        public BBACONVF003(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBACONVF003 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBACONVF003 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBACONVF003 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>Ongeldig bronformaat aangevraagd in &#39;Content-Type&#39; header</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F003</value>
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public string Type { get; set; }

        /// <summary>
        /// Kon bronformaat niet bepalen a.d.h.v. Content-type header [content-type].
        /// </summary>
        /// <value>Kon bronformaat niet bepalen a.d.h.v. Content-type header [content-type].</value>
