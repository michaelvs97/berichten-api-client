...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-CONV-F004")]
    public partial class BBACONVF004 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF004" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBACONVF004() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF004" /> class.
        /// </summary>
        /// <param name="title">Accept header niet aanwezig (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F004 (required).</param>
        /// <param name="detail">Er is geen &#39;Accept:&#39; header meegegeven waardoor niet bepaald kon worden welk doelformaat er gevraagd is. (required).</param>
        ...
        public BBACONVF004(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBACONVF004 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBACONVF004 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBACONVF004 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// Accept header niet aanwezig
        /// </summary>
        /// <value>Accept header niet aanwezig</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F004</value>
        ...
        /// </summary>
        /// <value>Er is geen &#39;Accept:&#39; header meegegeven waardoor niet bepaald kon worden welk doelformaat er gevraagd is.</value>
