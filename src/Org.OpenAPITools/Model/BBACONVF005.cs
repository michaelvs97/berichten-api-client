...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-CONV-F005")]
    public partial class BBACONVF005 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF005" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBACONVF005() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF005" /> class.
        /// </summary>
        /// <param name="title">Ongeldig doelformaat aangevraagd in &#39;Accept&#39; header (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F005 (required).</param>
        /// <param name="detail">Kon doelformaat niet bepalen a.d.h.v. Accept header: [accept-header] (required).</param>
        ...
        public BBACONVF005(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBACONVF005 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBACONVF005 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBACONVF005 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// Ongeldig doelformaat aangevraagd in &#39;Accept&#39; header
        /// </summary>
        /// <value>Ongeldig doelformaat aangevraagd in &#39;Accept&#39; header</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F005</value>
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public string Type { get; set; }

        /// <summary>
        /// Kon doelformaat niet bepalen a.d.h.v. Accept header: [accept-header]
        /// </summary>
        /// <value>Kon doelformaat niet bepalen a.d.h.v. Accept header: [accept-header]</value>
