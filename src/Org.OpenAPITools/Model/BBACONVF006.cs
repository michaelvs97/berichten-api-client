...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-CONV-F006")]
    public partial class BBACONVF006 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF006" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBACONVF006() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBACONVF006" /> class.
        /// </summary>
        /// <param name="title">Inputbericht is niet valide (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F006 (required).</param>
        /// <param name="detail">Het aangeleverde bericht kon niet ingenomen worden en voldoet waarschijnlijk niet aan de gestelde vereisten, foutmelding was: [foutmelding] (required).</param>
        ...
        public BBACONVF006(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBACONVF006 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBACONVF006 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBACONVF006 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// Inputbericht is niet valide
        /// </summary>
        /// <value>Inputbericht is niet valide</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F006</value>
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public string Type { get; set; }

        /// <summary>
        /// Het aangeleverde bericht kon niet ingenomen worden en voldoet waarschijnlijk niet aan de gestelde vereisten, foutmelding was: [foutmelding]
        /// </summary>
        /// <value>Het aangeleverde bericht kon niet ingenomen worden en voldoet waarschijnlijk niet aan de gestelde vereisten, foutmelding was: [foutmelding]</value>
