...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-DELETE-F001")]
    public partial class BBADELETEF001 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBADELETEF001" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBADELETEF001() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBADELETEF001" /> class.
        /// </summary>
        /// <param name="title">DELETEREQUEST_MESSAGE_EXPIRED (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F001 (required).</param>
        /// <param name="detail">Het bericht is niet langer beschikbaar omdat de retentietijd verstreken is. (required).</param>
        /// <param name="dateTime">dateTime.</param>
        public BBADELETEF001(string title = default, string type = default, string detail = default, DateTime dateTime = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBADELETEF001 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBADELETEF001 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBADELETEF001 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>DELETEREQUEST_MESSAGE_EXPIRED</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F001</value>
        ...
        /// Het bericht is niet langer beschikbaar omdat de retentietijd verstreken is.
        /// </summary>
        /// <value>Het bericht is niet langer beschikbaar omdat de retentietijd verstreken is.</value>
