...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-DELETE-F004")]
    public partial class BBADELETEF004 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBADELETEF004" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBADELETEF004() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBADELETEF004" /> class.
        /// </summary>
        /// <param name="title">DELETEREQUEST_REQUESTED_NUMBER_OF_MESSAGES_EXCEEDS_LIMIT (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F004 (required).</param>
        /// <param name="detail">Het aantal berichten dat in dit verzoek verwijderd dient te worden overschrijft het ingestelde limiet (required).</param>
        ...
        public BBADELETEF004(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBADELETEF004 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBADELETEF004 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBADELETEF004 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>DELETEREQUEST_REQUESTED_NUMBER_OF_MESSAGES_EXCEEDS_LIMIT</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F004</value>
        ...
        /// Het aantal berichten dat in dit verzoek verwijderd dient te worden overschrijft het ingestelde limiet
        /// </summary>
        /// <value>Het aantal berichten dat in dit verzoek verwijderd dient te worden overschrijft het ingestelde limiet</value>
