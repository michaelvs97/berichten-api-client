...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-F999")]
    public partial class BBAF999 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAF999" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="BBAF999" /> class.
        /// </summary>
        /// <param name="title">TECHNICAL_ERROR (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-F999 (required).</param>
        /// <param name="detail">Onbekende (/technische) fout..</param>
        ...
        public BBAF999(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAF999 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAF999 and cannot be null");
            }
            this.Type = type;
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-F999</value>
        ...
        /// Onbekende (/technische) fout.
        /// </summary>
        /// <value>Onbekende (/technische) fout.</value>
