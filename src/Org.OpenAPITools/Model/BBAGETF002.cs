...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-GET-F002")]
    public partial class BBAGETF002 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAGETF002" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAGETF002() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAGETF002" /> class.
        /// </summary>
        /// <param name="title">GETREQUEST_MESSAGE_CONTENT_DELETED (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F002 (required).</param>
        /// <param name="detail">Het bericht is niet langer beschikbaar omdat het verwijderd is. (required).</param>
        /// <param name="dateTime">dateTime.</param>
        public BBAGETF002(string title = default, string type = default, string detail = default, DateTime dateTime = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAGETF002 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAGETF002 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAGETF002 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>GETREQUEST_MESSAGE_CONTENT_DELETED</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F002</value>
        ...
        /// Het bericht is niet langer beschikbaar omdat het verwijderd is.
        /// </summary>
        /// <value>Het bericht is niet langer beschikbaar omdat het verwijderd is.</value>
