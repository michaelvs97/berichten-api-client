...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-GET-F003")]
    public partial class BBAGETF003 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAGETF003" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAGETF003() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAGETF003" /> class.
        /// </summary>
        /// <param name="title">GETREQUEST_MESSAGE_NOT_FOUND (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F003 (required).</param>
        /// <param name="detail">Onbekend berichtTransportId (required).</param>
        /// <param name="dateTime">dateTime.</param>
        public BBAGETF003(string title = default, string type = default, string detail = default, DateTime dateTime = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAGETF003 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAGETF003 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAGETF003 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>GETREQUEST_MESSAGE_NOT_FOUND</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F003</value>
