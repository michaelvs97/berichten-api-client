...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-GET-F004")]
    public partial class BBAGETF004 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAGETF004" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAGETF004() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAGETF004" /> class.
        /// </summary>
        /// <param name="title">GETREQUEST_REQUESTED_NUMBER_OF_MESSAGES_EXCEEDS_LIMIT (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F004 (required).</param>
        /// <param name="detail">Het aantal opgevraagde berichten overschreed het ingestelde limiet (required).</param>
        ...
        public BBAGETF004(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAGETF004 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAGETF004 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAGETF004 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>GETREQUEST_REQUESTED_NUMBER_OF_MESSAGES_EXCEEDS_LIMIT</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F004</value>
        ...
        /// Het aantal opgevraagde berichten overschreed het ingestelde limiet
        /// </summary>
        /// <value>Het aantal opgevraagde berichten overschreed het ingestelde limiet</value>
