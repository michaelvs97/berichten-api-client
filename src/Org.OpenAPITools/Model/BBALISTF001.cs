...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-LIST-F001")]
    public partial class BBALISTF001 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBALISTF001" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBALISTF001() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBALISTF001" /> class.
        /// </summary>
        /// <param name="title">LIST_MESSAGE_REQUEST_INVALID_PARAMETERS (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-LIST-F001 (required).</param>
        /// <param name="detail">Ongeldige zoekfilters opgegeven (required).</param>
        ...
        public BBALISTF001(string title = default, string type = default, string detail = default, DateTime dateTime = default, List<InvalidParametersInner> invalidParameters = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBALISTF001 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBALISTF001 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBALISTF001 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>LIST_MESSAGE_REQUEST_INVALID_PARAMETERS</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-LIST-F001</value>
        ...
        /// Ongeldige zoekfilters opgegeven
        /// </summary>
        /// <value>Ongeldige zoekfilters opgegeven</value>
