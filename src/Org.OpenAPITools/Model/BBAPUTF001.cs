...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-PUT-F001")]
    public partial class BBAPUTF001 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF001" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAPUTF001() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF001" /> class.
        /// </summary>
        /// <param name="title">PUTREQUEST_NUMBER_OF_MESSAGES_IN_REQUEST_EXCEEDS_LIMITS (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F001 (required).</param>
        /// <param name="detail">Het aantal berichten in het verzoek overschrijd het ingestelde limiet (required).</param>
        ...
        public BBAPUTF001(string title = default, string type = default, string detail = default, DateTime dateTime = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAPUTF001 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAPUTF001 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAPUTF001 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>PUTREQUEST_NUMBER_OF_MESSAGES_IN_REQUEST_EXCEEDS_LIMITS</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F001</value>
        ...
        /// Het aantal berichten in het verzoek overschrijd het ingestelde limiet
        /// </summary>
        /// <value>Het aantal berichten in het verzoek overschrijd het ingestelde limiet</value>
