...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-PUT-F002")]
    public partial class BBAPUTF002 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF002" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAPUTF002() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF002" /> class.
        /// </summary>
        /// <param name="title">PUTREQUEST_INVALID_FIELD_ERROR (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F002 (required).</param>
        /// <param name="detail">Een of meerdere velden in het bericht voldoen niet aan de gestelde eisen (required).</param>
        /// <param name="dateTime">dateTime.</param>
        /// <param name="invalidParameters">invalidParameters (required).</param>
        public BBAPUTF002(string title = default, string type = default, string detail = default, DateTime dateTime = default, List<InvalidParametersInner> invalidParameters = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAPUTF002 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAPUTF002 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAPUTF002 and cannot be null");
            }
            this.Detail = detail;
            // to ensure "invalidParameters" is required (not null)
            if (invalidParameters == null)
            {
                throw new ArgumentNullException("invalidParameters is a required property for BBAPUTF002 and cannot be null");
            }
        ...
        /// </summary>
        /// <value>PUTREQUEST_INVALID_FIELD_ERROR</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F002</value>
        ...
        /// Een of meerdere velden in het bericht voldoen niet aan de gestelde eisen
        /// </summary>
        /// <value>Een of meerdere velden in het bericht voldoen niet aan de gestelde eisen</value>
