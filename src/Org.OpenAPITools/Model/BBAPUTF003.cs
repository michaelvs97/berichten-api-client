...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-PUT-F003")]
    public partial class BBAPUTF003 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF003" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAPUTF003() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF003" /> class.
        /// </summary>
        /// <param name="title">PUTREQUEST_MESSAGE_COULD_NOT_BE_SEND (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F003 (required).</param>
        /// <param name="detail">Het bericht kon niet verzonden worden aan de geadresseerde (required).</param>
        /// <param name="dateTime">dateTime.</param>
        public BBAPUTF003(string title = default, string type = default, string detail = default, DateTime dateTime = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAPUTF003 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAPUTF003 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAPUTF003 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>PUTREQUEST_MESSAGE_COULD_NOT_BE_SEND</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F003</value>
        ...
        /// Het bericht kon niet verzonden worden aan de geadresseerde
        /// </summary>
        /// <value>Het bericht kon niet verzonden worden aan de geadresseerde</value>
