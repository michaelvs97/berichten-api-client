...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-PUT-F004")]
    public partial class BBAPUTF004 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF004" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBAPUTF004() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBAPUTF004" /> class.
        /// </summary>
        /// <param name="title">PUTREQUEST_SENDER_ACCOUNT_NOT_AVAILABLE (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F004 (required).</param>
        /// <param name="detail">Het bericht kon niet verzonden worden, uw account is niet beschikbaar (required).</param>
        /// <param name="dateTime">dateTime.</param>
        public BBAPUTF004(string title = default, string type = default, string detail = default, DateTime dateTime = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBAPUTF004 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBAPUTF004 and cannot be null");
            }
            this.Type = type;
            // to ensure "detail" is required (not null)
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BBAPUTF004 and cannot be null");
            }
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>PUTREQUEST_SENDER_ACCOUNT_NOT_AVAILABLE</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F004</value>
        ...
        /// Het bericht kon niet verzonden worden, uw account is niet beschikbaar
        /// </summary>
        /// <value>Het bericht kon niet verzonden worden, uw account is niet beschikbaar</value>
