...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BBA-SUMMARIZE-F001")]
    public partial class BBASUMMARIZEF001 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BBASUMMARIZEF001" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BBASUMMARIZEF001() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BBASUMMARIZEF001" /> class.
        /// </summary>
        /// <param name="title">SUMMARIZEREQUEST_INVALID_REQUEST_ERROR (required).</param>
        /// <param name="type">https://www.rvig.nl/brp/berichten-api/probleem/BBA-SUMMARIZE-F001 (required).</param>
        /// <param name="detail">Het verzoek is onjuist controleer de zoekparameters..</param>
        ...
        public BBASUMMARIZEF001(string title = default, string type = default, string detail = default, DateTime dateTime = default, List<InvalidParametersInner> invalidParameters = default, string instance = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BBASUMMARIZEF001 and cannot be null");
            }
            this.Title = title;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BBASUMMARIZEF001 and cannot be null");
            }
            this.Type = type;
            this.Detail = detail;
        ...
        /// </summary>
        /// <value>SUMMARIZEREQUEST_INVALID_REQUEST_ERROR</value>
        ...
        /// </summary>
        /// <value>https://www.rvig.nl/brp/berichten-api/probleem/BBA-SUMMARIZE-F001</value>
        ...
        /// Het verzoek is onjuist controleer de zoekparameters.
        /// </summary>
        /// <value>Het verzoek is onjuist controleer de zoekparameters.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BBASUMMARIZEF001 {\n");
