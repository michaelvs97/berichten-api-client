...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cb01")]
    public partial class Cb01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Cb01" /> class.
        /// </summary>
        ...
        public Cb01(string schema = default, string berichtType = default, string herhaling = default, string afnemersindicatie = default, string datumIngang = default, string datumEinde = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Cb01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Cb01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "afnemersindicatie" is required (not null)
            if (afnemersindicatie == null)
            {
                throw new ArgumentNullException("afnemersindicatie is a required property for Cb01 and cannot be null");
            }
            this.Afnemersindicatie = afnemersindicatie;
            // to ensure "datumIngang" is required (not null)
            if (datumIngang == null)
            {
                throw new ArgumentNullException("datumIngang is a required property for Cb01 and cannot be null");
            }
            this.DatumIngang = datumIngang;
            // to ensure "datumEinde" is required (not null)
            if (datumEinde == null)
            {
                throw new ArgumentNullException("datumEinde is a required property for Cb01 and cannot be null");
            }
