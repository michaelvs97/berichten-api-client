...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "converteer_200_response")]
    public partial class Converteer200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Converteer200Response" /> class.
        /// </summary>
        /// <param name="berichtInhoud">berichtInhoud.</param>
        /// <param name="validatieFouten">validatieFouten.</param>
        public Converteer200Response(LoBericht berichtInhoud = default, List<Converteer200ResponseValidatieFoutenInner> validatieFouten = default)
        {
            this.BerichtInhoud = berichtInhoud;
            this.ValidatieFouten = validatieFouten;
        }

        /// <summary>
        /// Gets or Sets BerichtInhoud
        /// </summary>
        [DataMember(Name = "berichtInhoud", EmitDefaultValue = false)]
        public LoBericht BerichtInhoud { get; set; }

        /// <summary>
        /// Gets or Sets ValidatieFouten
        /// </summary>
        [DataMember(Name = "validatieFouten", EmitDefaultValue = false)]
        public List<Converteer200ResponseValidatieFoutenInner> ValidatieFouten { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Converteer200Response {\n");
            sb.Append("  BerichtInhoud: ").Append(BerichtInhoud).Append("\n");
            sb.Append("  ValidatieFouten: ").Append(ValidatieFouten).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
