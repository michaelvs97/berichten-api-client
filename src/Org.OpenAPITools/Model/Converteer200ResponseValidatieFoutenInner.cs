...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "converteer_200_response_validatieFouten_inner")]
    public partial class Converteer200ResponseValidatieFoutenInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Converteer200ResponseValidatieFoutenInner" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="code">code.</param>
        /// <param name="message">message.</param>
        /// <param name="property">property.</param>
        /// <param name="evaluationPath">evaluationPath.</param>
        /// <param name="schemaLocation">schemaLocation.</param>
        /// <param name="messageKey">messageKey.</param>
        /// <param name="arguments">arguments.</param>
        public Converteer200ResponseValidatieFoutenInner(string type = default, string code = default, string message = default, string property = default, string evaluationPath = default, string schemaLocation = default, string messageKey = default, List<string> arguments = default)
        {
            this.Type = type;
            this.Code = code;
        ...
        /// <summary>
        /// Gets or Sets EvaluationPath
        /// </summary>
        [DataMember(Name = "evaluationPath", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Converteer200ResponseValidatieFoutenInner {\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  Code: ").Append(Code).Append("\n");
            sb.Append("  Message: ").Append(Message).Append("\n");
            sb.Append("  Property: ").Append(Property).Append("\n");
            sb.Append("  EvaluationPath: ").Append(EvaluationPath).Append("\n");
