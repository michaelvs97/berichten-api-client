...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(Converteer406ResponseJsonConverter))]
    [DataContract(Name = "converteer_406_response")]
    public partial class Converteer406Response : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Converteer406Response" /> class
        /// with the <see cref="BBACONVF001" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBACONVF001.</param>
        public Converteer406Response(BBACONVF001 actualInstance)
        {
        ...
        public Converteer406Response(BBACONVF005 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BBACONVF001, BBACONVF005");
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Converteer406Response {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, Converteer406Response.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of Converteer406Response
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of Converteer406Response</returns>
        public static Converteer406Response FromJson(string jsonString)
        {
            Converteer406Response newConverteer406Response = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newConverteer406Response;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newConverteer406Response = new Converteer406Response(JsonConvert.DeserializeObject<BBACONVF001>(jsonString, Converteer406Response.SerializerSettings));
                }
                else
                {
                    newConverteer406Response = new Converteer406Response(JsonConvert.DeserializeObject<BBACONVF001>(jsonString, Converteer406Response.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newConverteer406Response = new Converteer406Response(JsonConvert.DeserializeObject<BBACONVF005>(jsonString, Converteer406Response.SerializerSettings));
                }
                else
                {
                    newConverteer406Response = new Converteer406Response(JsonConvert.DeserializeObject<BBACONVF005>(jsonString, Converteer406Response.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for Converteer406Response
    /// </summary>
    public class Converteer406ResponseJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(Converteer406Response).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return Converteer406Response.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return Converteer406Response.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
