...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(Converteer415ResponseJsonConverter))]
    [DataContract(Name = "converteer_415_response")]
    public partial class Converteer415Response : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Converteer415Response" /> class
        /// with the <see cref="BBACONVF002" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBACONVF002.</param>
        public Converteer415Response(BBACONVF002 actualInstance)
        {
        ...
        public Converteer415Response(BBACONVF003 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(BBACONVF002) || value is BBACONVF002)
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BBACONVF002, BBACONVF003");
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Converteer415Response {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, Converteer415Response.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of Converteer415Response
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of Converteer415Response</returns>
        public static Converteer415Response FromJson(string jsonString)
        {
            Converteer415Response newConverteer415Response = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newConverteer415Response;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newConverteer415Response = new Converteer415Response(JsonConvert.DeserializeObject<BBACONVF002>(jsonString, Converteer415Response.SerializerSettings));
                }
                else
                {
                    newConverteer415Response = new Converteer415Response(JsonConvert.DeserializeObject<BBACONVF002>(jsonString, Converteer415Response.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newConverteer415Response = new Converteer415Response(JsonConvert.DeserializeObject<BBACONVF003>(jsonString, Converteer415Response.SerializerSettings));
                }
                else
                {
                    newConverteer415Response = new Converteer415Response(JsonConvert.DeserializeObject<BBACONVF003>(jsonString, Converteer415Response.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for Converteer415Response
    /// </summary>
    public class Converteer415ResponseJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(Converteer415Response).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return Converteer415Response.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return Converteer415Response.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
