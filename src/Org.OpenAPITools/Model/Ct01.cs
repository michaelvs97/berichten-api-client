...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Ct01")]
    public partial class Ct01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ct01" /> class.
        /// </summary>
        ...
        public Ct01(string schema = default, string berichtType = default, string herhaling = default, Autorisatietabelregel autorisatietabelregel = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Ct01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Ct01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "autorisatietabelregel" is required (not null)
            if (autorisatietabelregel == null)
            {
                throw new ArgumentNullException("autorisatietabelregel is a required property for Ct01 and cannot be null");
            }
