...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cw01")]
    public partial class Cw01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Cw01" /> class.
        /// </summary>
        ...
        /// <param name="berichtType">berichtType (required).</param>
        /// <param name="herhaling">herhaling (required).</param>
        /// <param name="afnemersindicatie">afnemersindicatie (required).</param>
        /// <param name="datumIngang">datumIngang (required).</param>
        /// <param name="datumEinde">datumEinde (required).</param>
        /// <param name="autorisatietabelregel">autorisatietabelregel (required).</param>
        public Cw01(string schema = default, string berichtType = default, string herhaling = default, string afnemersindicatie = default, string datumIngang = default, string datumEinde = default, Autorisatietabelregel autorisatietabelregel = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Cw01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Cw01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "afnemersindicatie" is required (not null)
            if (afnemersindicatie == null)
            {
                throw new ArgumentNullException("afnemersindicatie is a required property for Cw01 and cannot be null");
            }
            this.Afnemersindicatie = afnemersindicatie;
            // to ensure "datumIngang" is required (not null)
            if (datumIngang == null)
            {
                throw new ArgumentNullException("datumIngang is a required property for Cw01 and cannot be null");
            }
            this.DatumIngang = datumIngang;
            // to ensure "datumEinde" is required (not null)
            if (datumEinde == null)
            {
                throw new ArgumentNullException("datumEinde is a required property for Cw01 and cannot be null");
            }
            this.DatumEinde = datumEinde;
            // to ensure "autorisatietabelregel" is required (not null)
            if (autorisatietabelregel == null)
            {
                throw new ArgumentNullException("autorisatietabelregel is a required property for Cw01 and cannot be null");
            }
            this.Autorisatietabelregel = autorisatietabelregel;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets BerichtType
        /// </summary>
        [DataMember(Name = "berichtType", IsRequired = true, EmitDefaultValue = true)]
        public string BerichtType { get; set; }

        /// <summary>
        /// Gets or Sets Herhaling
        /// </summary>
        [DataMember(Name = "herhaling", IsRequired = true, EmitDefaultValue = true)]
        public string Herhaling { get; set; }

        /// <summary>
        /// Gets or Sets Afnemersindicatie
        /// </summary>
        [DataMember(Name = "afnemersindicatie", IsRequired = true, EmitDefaultValue = true)]
        public string Afnemersindicatie { get; set; }

        /// <summary>
        /// Gets or Sets DatumIngang
        /// </summary>
        [DataMember(Name = "datumIngang", IsRequired = true, EmitDefaultValue = true)]
        public string DatumIngang { get; set; }

        /// <summary>
        /// Gets or Sets DatumEinde
        /// </summary>
        [DataMember(Name = "datumEinde", IsRequired = true, EmitDefaultValue = true)]
        public string DatumEinde { get; set; }

        /// <summary>
        /// Gets or Sets Autorisatietabelregel
        /// </summary>
        [DataMember(Name = "autorisatietabelregel", IsRequired = true, EmitDefaultValue = true)]
        public Autorisatietabelregel Autorisatietabelregel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Cw01 {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  Herhaling: ").Append(Herhaling).Append("\n");
            sb.Append("  Afnemersindicatie: ").Append(Afnemersindicatie).Append("\n");
            sb.Append("  DatumIngang: ").Append(DatumIngang).Append("\n");
            sb.Append("  DatumEinde: ").Append(DatumEinde).Append("\n");
            sb.Append("  Autorisatietabelregel: ").Append(Autorisatietabelregel).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // BerichtType (string) minLength
            if (this.BerichtType != null && this.BerichtType.Length < 0)
            {
                yield return new ValidationResult("Invalid value for BerichtType, length must be greater than 0.", new [] { "BerichtType" });
            }

            // Herhaling (string) maxLength
            if (this.Herhaling != null && this.Herhaling.Length > 1)
            {
                yield return new ValidationResult("Invalid value for Herhaling, length must be less than 1.", new [] { "Herhaling" });
            }

            // Herhaling (string) minLength
            if (this.Herhaling != null && this.Herhaling.Length < 0)
            {
                yield return new ValidationResult("Invalid value for Herhaling, length must be greater than 0.", new [] { "Herhaling" });
            }

            // Afnemersindicatie (string) maxLength
            if (this.Afnemersindicatie != null && this.Afnemersindicatie.Length > 6)
            {
                yield return new ValidationResult("Invalid value for Afnemersindicatie, length must be less than 6.", new [] { "Afnemersindicatie" });
            }

            // Afnemersindicatie (string) minLength
            if (this.Afnemersindicatie != null && this.Afnemersindicatie.Length < 0)
            {
                yield return new ValidationResult("Invalid value for Afnemersindicatie, length must be greater than 0.", new [] { "Afnemersindicatie" });
            }

            // DatumIngang (string) maxLength
            if (this.DatumIngang != null && this.DatumIngang.Length > 8)
            {
                yield return new ValidationResult("Invalid value for DatumIngang, length must be less than 8.", new [] { "DatumIngang" });
            }

            // DatumIngang (string) minLength
            if (this.DatumIngang != null && this.DatumIngang.Length < 0)
            {
                yield return new ValidationResult("Invalid value for DatumIngang, length must be greater than 0.", new [] { "DatumIngang" });
            }

            // DatumEinde (string) maxLength
            if (this.DatumEinde != null && this.DatumEinde.Length > 8)
            {
                yield return new ValidationResult("Invalid value for DatumEinde, length must be less than 8.", new [] { "DatumEinde" });
            }

            // DatumEinde (string) minLength
            if (this.DatumEinde != null && this.DatumEinde.Length < 0)
            {
                yield return new ValidationResult("Invalid value for DatumEinde, length must be greater than 0.", new [] { "DatumEinde" });
            }
