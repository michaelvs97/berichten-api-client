...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "delete-message-antwoord")]
    public partial class DeleteMessageAntwoord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteMessageAntwoord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoord" /> class.
        /// </summary>
        /// <param name="interactieId">Een uniek ID wat aan het HTTP request gekoppeld wordt. (required).</param>
        /// <param name="succesvolVerwijderdeBerichten">In deze collectie staan de berichten die daadwerkelijk verwijderd zijn..</param>
        /// <param name="nietSuccesvolVerwijderdeBerichten">In deze collectie staan de berichten die niet verwijderd konden worden..</param>
        public DeleteMessageAntwoord(Guid interactieId = default, List<Guid> succesvolVerwijderdeBerichten = default, List<DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten> nietSuccesvolVerwijderdeBerichten = default)
        {
            this.InteractieId = interactieId;
            this.SuccesvolVerwijderdeBerichten = succesvolVerwijderdeBerichten;
            this.NietSuccesvolVerwijderdeBerichten = nietSuccesvolVerwijderdeBerichten;
        }
        ...
        /// </summary>
        /// <value>In deze collectie staan de berichten die daadwerkelijk verwijderd zijn.</value>
        [DataMember(Name = "succesvolVerwijderdeBerichten", EmitDefaultValue = false)]
        public List<Guid> SuccesvolVerwijderdeBerichten { get; set; }

        /// <summary>
        /// In deze collectie staan de berichten die niet verwijderd konden worden.
        /// </summary>
        /// <value>In deze collectie staan de berichten die niet verwijderd konden worden.</value>
        [DataMember(Name = "nietSuccesvolVerwijderdeBerichten", EmitDefaultValue = false)]
        public List<DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten> NietSuccesvolVerwijderdeBerichten { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMessageAntwoord {\n");
            sb.Append("  InteractieId: ").Append(InteractieId).Append("\n");
            sb.Append("  SuccesvolVerwijderdeBerichten: ").Append(SuccesvolVerwijderdeBerichten).Append("\n");
            sb.Append("  NietSuccesvolVerwijderdeBerichten: ").Append(NietSuccesvolVerwijderdeBerichten).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
