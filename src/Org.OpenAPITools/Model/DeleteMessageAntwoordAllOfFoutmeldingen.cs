...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(DeleteMessageAntwoordAllOfFoutmeldingenJsonConverter))]
    [DataContract(Name = "delete_message_antwoord_allOf_foutmeldingen")]
    public partial class DeleteMessageAntwoordAllOfFoutmeldingen : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBADELETEF001" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBADELETEF001.</param>
        public DeleteMessageAntwoordAllOfFoutmeldingen(BBADELETEF001 actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBADELETEF002" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBADELETEF002.</param>
        public DeleteMessageAntwoordAllOfFoutmeldingen(BBADELETEF002 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBADELETEF003" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBADELETEF003.</param>
        public DeleteMessageAntwoordAllOfFoutmeldingen(BBADELETEF003 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(BBADELETEF001) || value is BBADELETEF001)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBADELETEF002) || value is BBADELETEF002)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBADELETEF003) || value is BBADELETEF003)
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BBADELETEF001, BBADELETEF002, BBADELETEF003");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `BBADELETEF001`. If the actual instance is not `BBADELETEF001`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBADELETEF001</returns>
        public BBADELETEF001 GetBBADELETEF001()
        {
            return (BBADELETEF001)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBADELETEF002`. If the actual instance is not `BBADELETEF002`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBADELETEF002</returns>
        public BBADELETEF002 GetBBADELETEF002()
        {
            return (BBADELETEF002)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBADELETEF003`. If the actual instance is not `BBADELETEF003`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBADELETEF003</returns>
        public BBADELETEF003 GetBBADELETEF003()
        {
            return (BBADELETEF003)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMessageAntwoordAllOfFoutmeldingen {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, DeleteMessageAntwoordAllOfFoutmeldingen.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of DeleteMessageAntwoordAllOfFoutmeldingen
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of DeleteMessageAntwoordAllOfFoutmeldingen</returns>
        public static DeleteMessageAntwoordAllOfFoutmeldingen FromJson(string jsonString)
        {
            DeleteMessageAntwoordAllOfFoutmeldingen newDeleteMessageAntwoordAllOfFoutmeldingen = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newDeleteMessageAntwoordAllOfFoutmeldingen;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(BBADELETEF001).GetProperty("AdditionalProperties") == null)
                {
                    newDeleteMessageAntwoordAllOfFoutmeldingen = new DeleteMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBADELETEF001>(jsonString, DeleteMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newDeleteMessageAntwoordAllOfFoutmeldingen = new DeleteMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBADELETEF001>(jsonString, DeleteMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBADELETEF001");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBADELETEF001: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBADELETEF002).GetProperty("AdditionalProperties") == null)
                {
                    newDeleteMessageAntwoordAllOfFoutmeldingen = new DeleteMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBADELETEF002>(jsonString, DeleteMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newDeleteMessageAntwoordAllOfFoutmeldingen = new DeleteMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBADELETEF002>(jsonString, DeleteMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBADELETEF002");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBADELETEF002: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBADELETEF003).GetProperty("AdditionalProperties") == null)
                {
                    newDeleteMessageAntwoordAllOfFoutmeldingen = new DeleteMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBADELETEF003>(jsonString, DeleteMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newDeleteMessageAntwoordAllOfFoutmeldingen = new DeleteMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBADELETEF003>(jsonString, DeleteMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBADELETEF003");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBADELETEF003: {1}", jsonString, exception.ToString()));
            }
    ...
    /// <summary>
    /// Custom JSON converter for DeleteMessageAntwoordAllOfFoutmeldingen
    /// </summary>
    public class DeleteMessageAntwoordAllOfFoutmeldingenJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(DeleteMessageAntwoordAllOfFoutmeldingen).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return DeleteMessageAntwoordAllOfFoutmeldingen.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return DeleteMessageAntwoordAllOfFoutmeldingen.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
