...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "delete_message_antwoord_allOf_nietSuccesvolVerwijderdeBerichten")]
    public partial class DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten" /> class.
        /// </summary>
        ...
        public DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten(Guid berichtTransportId = default, List<DeleteMessageAntwoordAllOfFoutmeldingen> foutmeldingen = default)
        {
            this.BerichtTransportId = berichtTransportId;
            // to ensure "foutmeldingen" is required (not null)
            if (foutmeldingen == null)
            {
                throw new ArgumentNullException("foutmeldingen is a required property for DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten and cannot be null");
            }
        ...
        public List<DeleteMessageAntwoordAllOfFoutmeldingen> Foutmeldingen { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten {\n");
