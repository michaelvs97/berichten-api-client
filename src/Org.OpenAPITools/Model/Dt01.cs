...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Dt01")]
    public partial class Dt01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Dt01" /> class.
        /// </summary>
        ...
        public Dt01(string schema = default, string berichtType = default, string herhaling = default, string teWijzigenTabel = default, Object tabelData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Dt01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Dt01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "teWijzigenTabel" is required (not null)
            if (teWijzigenTabel == null)
            {
                throw new ArgumentNullException("teWijzigenTabel is a required property for Dt01 and cannot be null");
            }
            this.TeWijzigenTabel = teWijzigenTabel;
            // to ensure "tabelData" is required (not null)
            if (tabelData == null)
            {
                throw new ArgumentNullException("tabelData is a required property for Dt01 and cannot be null");
            }
