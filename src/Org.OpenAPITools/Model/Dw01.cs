...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Dw01")]
    public partial class Dw01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Dw01" /> class.
        /// </summary>
        ...
        /// <param name="teWijzigenTabel">teWijzigenTabel (required).</param>
        /// <param name="tabelData">Beschrijving van de inhoud van de tabelberichten (required).</param>
        public Dw01(string schema = default, string berichtType = default, string herhaling = default, string teWijzigenTabel = default, Object tabelData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Dw01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Dw01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "teWijzigenTabel" is required (not null)
            if (teWijzigenTabel == null)
            {
                throw new ArgumentNullException("teWijzigenTabel is a required property for Dw01 and cannot be null");
            }
            this.TeWijzigenTabel = teWijzigenTabel;
            // to ensure "tabelData" is required (not null)
            if (tabelData == null)
            {
                throw new ArgumentNullException("tabelData is a required property for Dw01 and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets TeWijzigenTabel
        /// </summary>
        [DataMember(Name = "teWijzigenTabel", IsRequired = true, EmitDefaultValue = true)]
        public string TeWijzigenTabel { get; set; }

        /// <summary>
        /// Beschrijving van de inhoud van de tabelberichten
        /// </summary>
        /// <value>Beschrijving van de inhoud van de tabelberichten</value>
        [DataMember(Name = "tabelData", IsRequired = true, EmitDefaultValue = true)]
        public Object TabelData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Dw01 {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  Herhaling: ").Append(Herhaling).Append("\n");
            sb.Append("  TeWijzigenTabel: ").Append(TeWijzigenTabel).Append("\n");
            sb.Append("  TabelData: ").Append(TabelData).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // TeWijzigenTabel (string) maxLength
            if (this.TeWijzigenTabel != null && this.TeWijzigenTabel.Length > 2)
            {
                yield return new ValidationResult("Invalid value for TeWijzigenTabel, length must be less than 2.", new [] { "TeWijzigenTabel" });
            }

            // TeWijzigenTabel (string) minLength
            if (this.TeWijzigenTabel != null && this.TeWijzigenTabel.Length < 0)
            {
                yield return new ValidationResult("Invalid value for TeWijzigenTabel, length must be greater than 0.", new [] { "TeWijzigenTabel" });
            }
