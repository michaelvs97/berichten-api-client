...
namespace Org.OpenAPITools.Model
{
    ...
    /// Foutmelding
    /// </summary>
    [DataContract(Name = "Foutmelding")]
    public partial class Foutmelding : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Foutmelding" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="Foutmelding" /> class.
        /// </summary>
        /// <param name="type">Unieke (RFC7807) foutcode voor het type van de opgetreden fout. Een namespace URI-pad gevolgd door een type fout id in de vorm VVV-DDDD-FFFF waarbij VVV gelijk is aan de afkorting van de voorziening (in dit geval BBA voor BRP Berichten API). DDDD een indicatie geeft van de operatie/domein waar de fout is opgetreden en FFFF een opdeling betreft van specifieke fouten (types) welke binnen een domein zijn identificeert.  (required).</param>
        /// <param name="title">De titel (RFC7807) geeft een korte uitleg van het soort fout en in sommige gevallen een toelichting van de oorzaak.  (required).</param>
        /// <param name="detail">Dit (RFC7807) veld geeft toelichting die kan helpen om de oorzaak van de fout te achterhalen, of geeft achtergrondinformatie over de foutsituatie. .</param>
        /// <param name="status">Dit (RFC7807) veld beschrijft de HTTP status-code die door de BRP-Berichten-API is toegekend aan de fout (indien van toepassing). (required).</param>
        /// <param name="instance">Dit (RFC7807) veld beschrijft het request waarbij dit probleem is opgetreden (indien van toepassing)..</param>
        /// <param name="invalidParameters">invalidParameters.</param>
        /// <param name="dateTime">Het tijdstip en de datum (ISO date/time) waarop de fout is afgevangen en het foutmelding object is samengesteld. .</param>
        public Foutmelding(string type = default, string title = default, string detail = default, int status = default, string instance = default, List<InvalidParametersInner> invalidParameters = default, DateTime dateTime = default)
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Foutmelding and cannot be null");
            }
            this.Type = type;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for Foutmelding and cannot be null");
            }
            this.Title = title;
            this.Status = status;
            this.Detail = detail;
        ...
        /// <summary>
        /// Unieke (RFC7807) foutcode voor het type van de opgetreden fout. Een namespace URI-pad gevolgd door een type fout id in de vorm VVV-DDDD-FFFF waarbij VVV gelijk is aan de afkorting van de voorziening (in dit geval BBA voor BRP Berichten API). DDDD een indicatie geeft van de operatie/domein waar de fout is opgetreden en FFFF een opdeling betreft van specifieke fouten (types) welke binnen een domein zijn identificeert. 
        /// </summary>
        /// <value>Unieke (RFC7807) foutcode voor het type van de opgetreden fout. Een namespace URI-pad gevolgd door een type fout id in de vorm VVV-DDDD-FFFF waarbij VVV gelijk is aan de afkorting van de voorziening (in dit geval BBA voor BRP Berichten API). DDDD een indicatie geeft van de operatie/domein waar de fout is opgetreden en FFFF een opdeling betreft van specifieke fouten (types) welke binnen een domein zijn identificeert. </value>
        ...
        /// </summary>
        /// <value>De titel (RFC7807) geeft een korte uitleg van het soort fout en in sommige gevallen een toelichting van de oorzaak. </value>
        ...
        /// </summary>
        /// <value>Dit (RFC7807) veld geeft toelichting die kan helpen om de oorzaak van de fout te achterhalen, of geeft achtergrondinformatie over de foutsituatie. </value>
        [DataMember(Name = "detail", EmitDefaultValue = false)]
        public string Detail { get; set; }

        /// <summary>
        /// Dit (RFC7807) veld beschrijft de HTTP status-code die door de BRP-Berichten-API is toegekend aan de fout (indien van toepassing).
        /// </summary>
        /// <value>Dit (RFC7807) veld beschrijft de HTTP status-code die door de BRP-Berichten-API is toegekend aan de fout (indien van toepassing).</value>
        [DataMember(Name = "status", IsRequired = true, EmitDefaultValue = true)]
        public int Status { get; set; }

        /// <summary>
        /// Dit (RFC7807) veld beschrijft het request waarbij dit probleem is opgetreden (indien van toepassing).
        /// </summary>
        /// <value>Dit (RFC7807) veld beschrijft het request waarbij dit probleem is opgetreden (indien van toepassing).</value>
        [DataMember(Name = "instance", EmitDefaultValue = false)]
        public string Instance { get; set; }

        /// <summary>
        /// Gets or Sets InvalidParameters
        /// </summary>
        [DataMember(Name = "invalidParameters", EmitDefaultValue = false)]
        public List<InvalidParametersInner> InvalidParameters { get; set; }

        /// <summary>
        /// Het tijdstip en de datum (ISO date/time) waarop de fout is afgevangen en het foutmelding object is samengesteld. 
        /// </summary>
        /// <value>Het tijdstip en de datum (ISO date/time) waarop de fout is afgevangen en het foutmelding object is samengesteld. </value>
