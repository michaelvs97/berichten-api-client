...
namespace Org.OpenAPITools.Model
{
    ...
    /// GeneriekAntwoord
    /// </summary>
    [DataContract(Name = "generiek-antwoord")]
    public partial class GeneriekAntwoord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneriekAntwoord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GeneriekAntwoord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneriekAntwoord" /> class.
        /// </summary>
        /// <param name="interactieId">Een uniek ID wat aan het HTTP request gekoppeld wordt. (required).</param>
        public GeneriekAntwoord(Guid interactieId = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeneriekAntwoord {\n");
