...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetMessageAntwoord
    /// </summary>
    [DataContract(Name = "get-message-antwoord")]
    public partial class GetMessageAntwoord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMessageAntwoord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoord" /> class.
        /// </summary>
        /// <param name="interactieId">Een uniek ID wat aan het HTTP request gekoppeld wordt. (required).</param>
        /// <param name="opgehaaldeBerichten">Gevraagde berichten die ook succesvol opgehaald konden worden. (required).</param>
        /// <param name="nietOpgehaaldeBerichten">Gevraagde berichten die niet succesvol opgehaald konden worden. (required).</param>
        public GetMessageAntwoord(Guid interactieId = default, List<GetMessageAntwoordAllOfOpgehaaldeBerichten> opgehaaldeBerichten = default, List<GetMessageAntwoordAllOfNietOpgehaaldeBerichten> nietOpgehaaldeBerichten = default)
        {
            this.InteractieId = interactieId;
            // to ensure "opgehaaldeBerichten" is required (not null)
            if (opgehaaldeBerichten == null)
            {
                throw new ArgumentNullException("opgehaaldeBerichten is a required property for GetMessageAntwoord and cannot be null");
            }
            this.OpgehaaldeBerichten = opgehaaldeBerichten;
            // to ensure "nietOpgehaaldeBerichten" is required (not null)
            if (nietOpgehaaldeBerichten == null)
            {
                throw new ArgumentNullException("nietOpgehaaldeBerichten is a required property for GetMessageAntwoord and cannot be null");
            }
            this.NietOpgehaaldeBerichten = nietOpgehaaldeBerichten;
        }

        /// <summary>
        /// Een uniek ID wat aan het HTTP request gekoppeld wordt.
        /// </summary>
        /// <value>Een uniek ID wat aan het HTTP request gekoppeld wordt.</value>
        [DataMember(Name = "interactieId", IsRequired = true, EmitDefaultValue = true)]
        public Guid InteractieId { get; set; }

        /// <summary>
        /// Gevraagde berichten die ook succesvol opgehaald konden worden.
        /// </summary>
        /// <value>Gevraagde berichten die ook succesvol opgehaald konden worden.</value>
        [DataMember(Name = "opgehaaldeBerichten", IsRequired = true, EmitDefaultValue = true)]
        public List<GetMessageAntwoordAllOfOpgehaaldeBerichten> OpgehaaldeBerichten { get; set; }

        /// <summary>
        /// Gevraagde berichten die niet succesvol opgehaald konden worden.
        /// </summary>
        /// <value>Gevraagde berichten die niet succesvol opgehaald konden worden.</value>
        [DataMember(Name = "nietOpgehaaldeBerichten", IsRequired = true, EmitDefaultValue = true)]
        public List<GetMessageAntwoordAllOfNietOpgehaaldeBerichten> NietOpgehaaldeBerichten { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetMessageAntwoord {\n");
            sb.Append("  InteractieId: ").Append(InteractieId).Append("\n");
            sb.Append("  OpgehaaldeBerichten: ").Append(OpgehaaldeBerichten).Append("\n");
            sb.Append("  NietOpgehaaldeBerichten: ").Append(NietOpgehaaldeBerichten).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
