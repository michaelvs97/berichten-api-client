...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetMessageAntwoordAllOfFoutmeldingenJsonConverter))]
    [DataContract(Name = "get_message_antwoord_allOf_foutmeldingen")]
    public partial class GetMessageAntwoordAllOfFoutmeldingen : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBAGETF001" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAGETF001.</param>
        public GetMessageAntwoordAllOfFoutmeldingen(BBAGETF001 actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBAGETF002" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAGETF002.</param>
        public GetMessageAntwoordAllOfFoutmeldingen(BBAGETF002 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBAGETF003" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAGETF003.</param>
        public GetMessageAntwoordAllOfFoutmeldingen(BBAGETF003 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(BBAGETF001) || value is BBAGETF001)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBAGETF002) || value is BBAGETF002)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBAGETF003) || value is BBAGETF003)
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BBAGETF001, BBAGETF002, BBAGETF003");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `BBAGETF001`. If the actual instance is not `BBAGETF001`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAGETF001</returns>
        public BBAGETF001 GetBBAGETF001()
        {
            return (BBAGETF001)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBAGETF002`. If the actual instance is not `BBAGETF002`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAGETF002</returns>
        public BBAGETF002 GetBBAGETF002()
        {
            return (BBAGETF002)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBAGETF003`. If the actual instance is not `BBAGETF003`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAGETF003</returns>
        public BBAGETF003 GetBBAGETF003()
        {
            return (BBAGETF003)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetMessageAntwoordAllOfFoutmeldingen {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetMessageAntwoordAllOfFoutmeldingen.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetMessageAntwoordAllOfFoutmeldingen
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetMessageAntwoordAllOfFoutmeldingen</returns>
        public static GetMessageAntwoordAllOfFoutmeldingen FromJson(string jsonString)
        {
            GetMessageAntwoordAllOfFoutmeldingen newGetMessageAntwoordAllOfFoutmeldingen = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetMessageAntwoordAllOfFoutmeldingen;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(BBAGETF001).GetProperty("AdditionalProperties") == null)
                {
                    newGetMessageAntwoordAllOfFoutmeldingen = new GetMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAGETF001>(jsonString, GetMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newGetMessageAntwoordAllOfFoutmeldingen = new GetMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAGETF001>(jsonString, GetMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAGETF001");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAGETF001: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBAGETF002).GetProperty("AdditionalProperties") == null)
                {
                    newGetMessageAntwoordAllOfFoutmeldingen = new GetMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAGETF002>(jsonString, GetMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newGetMessageAntwoordAllOfFoutmeldingen = new GetMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAGETF002>(jsonString, GetMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAGETF002");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAGETF002: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBAGETF003).GetProperty("AdditionalProperties") == null)
                {
                    newGetMessageAntwoordAllOfFoutmeldingen = new GetMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAGETF003>(jsonString, GetMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newGetMessageAntwoordAllOfFoutmeldingen = new GetMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAGETF003>(jsonString, GetMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAGETF003");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAGETF003: {1}", jsonString, exception.ToString()));
            }
    ...
    /// <summary>
    /// Custom JSON converter for GetMessageAntwoordAllOfFoutmeldingen
    /// </summary>
    public class GetMessageAntwoordAllOfFoutmeldingenJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetMessageAntwoordAllOfFoutmeldingen).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return GetMessageAntwoordAllOfFoutmeldingen.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return GetMessageAntwoordAllOfFoutmeldingen.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
