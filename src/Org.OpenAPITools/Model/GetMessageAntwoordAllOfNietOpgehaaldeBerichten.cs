...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_message_antwoord_allOf_nietOpgehaaldeBerichten")]
    public partial class GetMessageAntwoordAllOfNietOpgehaaldeBerichten : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfNietOpgehaaldeBerichten" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMessageAntwoordAllOfNietOpgehaaldeBerichten() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfNietOpgehaaldeBerichten" /> class.
        /// </summary>
        ...
        public GetMessageAntwoordAllOfNietOpgehaaldeBerichten(Guid berichtTransportId = default, List<GetMessageAntwoordAllOfFoutmeldingen> foutmeldingen = default)
        {
            this.BerichtTransportId = berichtTransportId;
            // to ensure "foutmeldingen" is required (not null)
            if (foutmeldingen == null)
            {
                throw new ArgumentNullException("foutmeldingen is a required property for GetMessageAntwoordAllOfNietOpgehaaldeBerichten and cannot be null");
            }
        ...
        public List<GetMessageAntwoordAllOfFoutmeldingen> Foutmeldingen { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetMessageAntwoordAllOfNietOpgehaaldeBerichten {\n");
