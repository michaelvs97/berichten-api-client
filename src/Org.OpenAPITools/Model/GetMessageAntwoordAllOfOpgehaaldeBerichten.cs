...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_message_antwoord_allOf_opgehaaldeBerichten")]
    public partial class GetMessageAntwoordAllOfOpgehaaldeBerichten : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfOpgehaaldeBerichten" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMessageAntwoordAllOfOpgehaaldeBerichten() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageAntwoordAllOfOpgehaaldeBerichten" /> class.
        /// </summary>
        /// <param name="berichtKenmerken">berichtKenmerken (required).</param>
        /// <param name="berichtInhoud">berichtInhoud (required).</param>
        public GetMessageAntwoordAllOfOpgehaaldeBerichten(GetMessageKenmerken berichtKenmerken = default, LoBericht berichtInhoud = default)
        {
            // to ensure "berichtKenmerken" is required (not null)
            if (berichtKenmerken == null)
            {
                throw new ArgumentNullException("berichtKenmerken is a required property for GetMessageAntwoordAllOfOpgehaaldeBerichten and cannot be null");
            }
            this.BerichtKenmerken = berichtKenmerken;
            // to ensure "berichtInhoud" is required (not null)
            if (berichtInhoud == null)
            {
                throw new ArgumentNullException("berichtInhoud is a required property for GetMessageAntwoordAllOfOpgehaaldeBerichten and cannot be null");
            }
            this.BerichtInhoud = berichtInhoud;
        }

        /// <summary>
        /// Gets or Sets BerichtKenmerken
        /// </summary>
        [DataMember(Name = "berichtKenmerken", IsRequired = true, EmitDefaultValue = true)]
        public GetMessageKenmerken BerichtKenmerken { get; set; }

        /// <summary>
        /// Gets or Sets BerichtInhoud
        /// </summary>
        [DataMember(Name = "berichtInhoud", IsRequired = true, EmitDefaultValue = true)]
        public LoBericht BerichtInhoud { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetMessageAntwoordAllOfOpgehaaldeBerichten {\n");
            sb.Append("  BerichtKenmerken: ").Append(BerichtKenmerken).Append("\n");
            sb.Append("  BerichtInhoud: ").Append(BerichtInhoud).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
