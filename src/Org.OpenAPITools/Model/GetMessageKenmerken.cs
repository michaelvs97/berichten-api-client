...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetMessageKenmerken
    /// </summary>
    [DataContract(Name = "GetMessageKenmerken")]
    public partial class GetMessageKenmerken : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageKenmerken" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMessageKenmerken() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageKenmerken" /> class.
        /// </summary>
        ...
        public GetMessageKenmerken(string berichtId = default, string verwijzingBerichtId = default, string berichtType = default, Guid berichtTransportId = default, long berichtVolgnummer = default, int afzender = default, int ontvanger = default, DateTime dtOntvangen = default, bool opgehaald = default, DateTime dtBewaardTot = default)
        {
            // to ensure "berichtId" is required (not null)
            if (berichtId == null)
            {
                throw new ArgumentNullException("berichtId is a required property for GetMessageKenmerken and cannot be null");
            }
            this.BerichtId = berichtId;
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for GetMessageKenmerken and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetMessageKenmerken {\n");
