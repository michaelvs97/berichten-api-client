...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Gv02")]
    public partial class Gv02 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Gv02" /> class.
        /// </summary>
        ...
        public Gv02(string schema = default, string berichtType = default, string aNummer = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Gv02 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Gv02 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Gv02 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
