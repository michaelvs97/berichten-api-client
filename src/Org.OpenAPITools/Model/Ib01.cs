...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Ib01")]
    public partial class Ib01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ib01" /> class.
        /// </summary>
        ...
        public Ib01(string schema = default, string berichtType = default, string herhaling = default, string status = default, string datum = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Ib01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Ib01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for Ib01 and cannot be null");
            }
            this.Status = status;
            // to ensure "datum" is required (not null)
            if (datum == null)
            {
                throw new ArgumentNullException("datum is a required property for Ib01 and cannot be null");
            }
            this.Datum = datum;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Ib01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Status, length must be less than 1.", new [] { "Status" });
            }
