...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "If41")]
    public partial class If41 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="If41" /> class.
        /// </summary>
        ...
        public If41(string schema = default, string berichtType = default, string foutreden = default, string gemeente = default, string aNummer = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for If41 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "foutreden" is required (not null)
            if (foutreden == null)
            {
                throw new ArgumentNullException("foutreden is a required property for If41 and cannot be null");
            }
            this.Foutreden = foutreden;
            // to ensure "gemeente" is required (not null)
            if (gemeente == null)
            {
                throw new ArgumentNullException("gemeente is a required property for If41 and cannot be null");
            }
            this.Gemeente = gemeente;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for If41 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for If41 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
