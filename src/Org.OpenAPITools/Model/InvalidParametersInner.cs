...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "invalidParameters_inner")]
    public partial class InvalidParametersInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidParametersInner" /> class.
        /// </summary>
        /// <param name="key">key.</param>
        /// <param name="value">value.</param>
        public InvalidParametersInner(string key = default, string value = default)
        {
            this.Key = key;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidParametersInner {\n");
