...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Jf21")]
    public partial class Jf21 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Jf21" /> class.
        /// </summary>
        ...
        public Jf21(string schema = default, string berichtType = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Jf21 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Jf21 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
