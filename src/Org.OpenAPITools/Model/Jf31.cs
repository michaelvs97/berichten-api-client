...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Jf31")]
    public partial class Jf31 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Jf31" /> class.
        /// </summary>
        ...
        public Jf31(string schema = default, string berichtType = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Jf31 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Jf31 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
