...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Jv01")]
    public partial class Jv01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Jv01" /> class.
        /// </summary>
        ...
        public Jv01(string schema = default, string berichtType = default, string herhaling = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Jv01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Jv01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Jv01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
