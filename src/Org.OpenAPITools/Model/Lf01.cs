...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Lf01")]
    public partial class Lf01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Lf01" /> class.
        /// </summary>
        ...
        public Lf01(string schema = default, string berichtType = default, string foutreden = default, string gemeente = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Lf01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "foutreden" is required (not null)
            if (foutreden == null)
            {
                throw new ArgumentNullException("foutreden is a required property for Lf01 and cannot be null");
            }
            this.Foutreden = foutreden;
            // to ensure "gemeente" is required (not null)
            if (gemeente == null)
            {
                throw new ArgumentNullException("gemeente is a required property for Lf01 and cannot be null");
            }
            this.Gemeente = gemeente;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Lf01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
