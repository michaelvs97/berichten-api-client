...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Lg01")]
    public partial class Lg01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Lg01" /> class.
        /// </summary>
        ...
        /// <param name="datumTijd">datumTijd (required).</param>
        /// <param name="aNummer">aNummer (required).</param>
        /// <param name="oudANummer">oudANummer (required).</param>
        /// <param name="plData">plData (required).</param>
        public Lg01(string schema = default, string berichtType = default, string datumTijd = default, string aNummer = default, string oudANummer = default, Lg01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Lg01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "datumTijd" is required (not null)
            if (datumTijd == null)
            {
                throw new ArgumentNullException("datumTijd is a required property for Lg01 and cannot be null");
            }
            this.DatumTijd = datumTijd;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Lg01 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "oudANummer" is required (not null)
            if (oudANummer == null)
            {
                throw new ArgumentNullException("oudANummer is a required property for Lg01 and cannot be null");
            }
            this.OudANummer = oudANummer;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Lg01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets DatumTijd
        /// </summary>
        [DataMember(Name = "datumTijd", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets OudANummer
        /// </summary>
        [DataMember(Name = "oudANummer", IsRequired = true, EmitDefaultValue = true)]
        public string OudANummer { get; set; }

        /// <summary>
        /// Gets or Sets PlData
        /// </summary>
        [DataMember(Name = "plData", IsRequired = true, EmitDefaultValue = true)]
        public Lg01PlData PlData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Lg01 {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  DatumTijd: ").Append(DatumTijd).Append("\n");
            sb.Append("  ANummer: ").Append(ANummer).Append("\n");
            sb.Append("  OudANummer: ").Append(OudANummer).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DatumTijd (string) maxLength
            if (this.DatumTijd != null && this.DatumTijd.Length > 17)
            {
                yield return new ValidationResult("Invalid value for DatumTijd, length must be less than 17.", new [] { "DatumTijd" });
            }

            // DatumTijd (string) minLength
            if (this.DatumTijd != null && this.DatumTijd.Length < 0)
            {
                yield return new ValidationResult("Invalid value for DatumTijd, length must be greater than 0.", new [] { "DatumTijd" });
            }
            ...
            // OudANummer (string) maxLength
            if (this.OudANummer != null && this.OudANummer.Length > 10)
            {
                yield return new ValidationResult("Invalid value for OudANummer, length must be less than 10.", new [] { "OudANummer" });
            }

            // OudANummer (string) minLength
            if (this.OudANummer != null && this.OudANummer.Length < 0)
            {
                yield return new ValidationResult("Invalid value for OudANummer, length must be greater than 0.", new [] { "OudANummer" });
            }
