...
namespace Org.OpenAPITools.Model
{
    ...
    /// ListMessageAntwoord
    /// </summary>
    [DataContract(Name = "list-message-antwoord")]
    public partial class ListMessageAntwoord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessageAntwoord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListMessageAntwoord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessageAntwoord" /> class.
        /// </summary>
        /// <param name="interactieId">Een uniek ID wat aan het HTTP request gekoppeld wordt. (required).</param>
        /// <param name="paginering">paginering (required).</param>
        /// <param name="berichten">berichten (required).</param>
        public ListMessageAntwoord(Guid interactieId = default, PagineringResultaat paginering = default, List<ListMessageKenmerken> berichten = default)
        {
            this.InteractieId = interactieId;
            // to ensure "paginering" is required (not null)
            if (paginering == null)
            {
                throw new ArgumentNullException("paginering is a required property for ListMessageAntwoord and cannot be null");
            }
            this.Paginering = paginering;
            // to ensure "berichten" is required (not null)
            if (berichten == null)
            {
                throw new ArgumentNullException("berichten is a required property for ListMessageAntwoord and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets Paginering
        /// </summary>
        [DataMember(Name = "paginering", IsRequired = true, EmitDefaultValue = true)]
        public PagineringResultaat Paginering { get; set; }

        /// <summary>
        /// Gets or Sets Berichten
        /// </summary>
        [DataMember(Name = "berichten", IsRequired = true, EmitDefaultValue = true)]
        public List<ListMessageKenmerken> Berichten { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListMessageAntwoord {\n");
            sb.Append("  InteractieId: ").Append(InteractieId).Append("\n");
            sb.Append("  Paginering: ").Append(Paginering).Append("\n");
            sb.Append("  Berichten: ").Append(Berichten).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
