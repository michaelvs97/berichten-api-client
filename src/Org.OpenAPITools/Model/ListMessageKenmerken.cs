...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ListMessageKenmerken : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Het unieke volgnummer dat aan het uitgaande bericht wordt toegekend door de afzender. De \&quot;BRP berichten API\&quot; voert geen inhoudelijke controles uit op dit BerichtId. Maximaal 12 posities. </value>
        [DataMember(Name = "berichtId", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Indien het bericht een antwoord is op een eerder door het eindsysteem ontvangen bericht: het &#x60;berichtId&#x60; van het eerder ontvangen bericht. Het veld correspondeert met het \&quot;CrossReference\&quot; veld van de mailboxserver.  Het volgnummer van het bericht, waarop dit uitgaande bericht een reactie is. Dit volgnummer is het MessageId van het voorgaande bericht uit de cyclus. Is het bericht het eerste van een cyclus dan kan dit veld of weggelaten worden, of gevuld worden met 0; </value>
        [DataMember(Name = "verwijzingBerichtId", EmitDefaultValue = false)]
        public string VerwijzingBerichtId { get; set; }

        /// <summary>
        /// Het soort bericht (zoals gedefinieerd in het berichtenboek in het Logisch Ontwerp).  * Berichten ten behoeve van de bijhouding en de consistentie van de BRP   * Berichten tussen bijhouders onderling     * Berichten in verband met de vervolginschrijving tussen gemeenten:       * Ii01 Initiatie intergemeentelijke verhuizing       * Ib01 Verhuizen PL intergemeentelijk       * Iv01 Verwijsgegevens       * If01 Fout: PL niet te verzenden       * If21 Fout: de ontvangen PL is niet de aangevraagde       * If31 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met de vervolginschrijving van de gemeente naar de RNI:       * Rb01 Verhuizen PL van gemeente naar RNI       * Rv01 Verwijsgegevens       * Rf01 Fout: de ontvangen PL kan niet worden opgenomen       * Rf31 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met de vervolginschrijving van de RNI naar de gemeente:       * Ji01 Initiatie verhuizing PL van RNI naar gemeente       * Jb01 Verhuizen PL van RNI naar gemeente       * Jv01 Verwijsgegevens       * Jf01 Fout: PL niet te verzenden       * Jf21 Fout: de ontvangen PL is niet de aangevraagde       * Jf31 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met een toevallige geboorte:       * Tb01 Toevallige geboorte       * Tv01 Verwijsgegevens       * Tf01 Fout: persoon niet in te schrijven       * Tf11 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met een toevallige gebeurtenis:       * Tb02 Toevallige gebeurtenis       * Tf21 Fout: gebeurtenisgegevens niet te verwerken     * Berichten in verband met het opnemen van verwijsgegevens:       * Iv11 Verwijsgegevens       * Iv21 Verificatie verwijsgegevens       * If41 Fout: verwijsgegevens kunnen niet worden opgenomen     * Berichten in verband met wijzigen A-nummer in de verwijsgegevens bij gemeenten en bij de RNI:       * Wa01 Wijziging A-nummer       * Wf01 Fout: A-nummerwijziging niet te verwerken   * Berichten ten behoeve van de bijhouding     * Berichten in verband met verblijfstitel:       * Og11 Opnemen gegevens verblijfstitel       * Of11 Fout: opnemen/wijzigen verblijfstitel niet mogelijk   * Berichten ten behoeve van het bijhouden van de persoonsgegevens in BRP-V     * Berichten in verband met synchronisatie met BRP-V:       * Lg01 Synchronisatiebericht       * Lq01 Synchronisatievraag       * La01 Synchronisatieantwoord       * Lf01 Fout: synchronisatievraag niet te beantwoorden     * Berichten in verband met synchroniciteitsselecties:       * Lg01 Synchronisatiebericht * Berichten ten behoeve van de gegevensverstrekkingen   * Berichten in verband met spontane gegevensverstrekkingen als gevolg van afnemersindicaties op persoonslijsten:     * Gv01 Spontane mutatie     * Gv02 Spontane mutatie: infrastructurele wijziging     * Wa11 Wijziging A-nummer ten behoeve van afnemers     * Ng01 Afvoeren PL     * Ag11 Vulbericht     * Ag21 Conditionele gegevensverstrekking     * Ag31 Foutherstelbericht   * Berichten in verband met selecties:     * Sv01 Selectieverstrekking     * Sv11 Niemand geselecteerd   * Berichten in verband met ad hoc vragen:     * Hq01 Ad hoc vraag     * Ha01 Ad hoc antwoord     * Hf01 Fout: ad hoc vraag niet te beantwoorden   * Berichten in verband met ad hoc adresvragen:     * Xq01 Ad hoc adresvraag     * Xa01 Ad hoc adresantwoord     * Xf01 Fout: ad hoc adresvraag niet te beantwoorden   * Berichten in verband met het muteren van afnemersindicaties op persoonslijsten:     * Ap01 Plaatsen afnemersindicatie op persoonslijst     * Ag01 Gegevensverstrekking als gevolg van ad hoc plaatsing afnemersindicatie op persoonslijst     * Af01 Fout: plaatsen afnemersindicatie op persoonslijst onmogelijk     * Av01 Verwijderen afnemersindicatie van persoonslijst     * Af11 Fout: verwijderen afnemersindicatie van persoonslijst onmogelijk * Overige berichten   * Berichten ten behoeve van het onderhouden van de autorisatietabel     * Berichten in verband met het onderhoud van de autorisatietabel:       * Ct01 Toevoegen tabelregel aan Autorisatietabel       * Cw01 Wijzigen tabelregel in Autorisatietabel       * Cb01 Beëindigen tabelregel in Autorisatietabel     * Berichten ten behoeve van het onderhouden van de overige landelijke tabellen       * Dt01 Toevoegen tabelregel       * Dw01 Wijzigen tabelregel     * De protocolfouten       * Berichten om niet voorziene fouten in ontvangen berichten te melden:         * Pf01 Fout: cyclus         * Pf02 Fout: syntax         * Pf03 Fout: inhoudelijk     * Het vrije bericht       * Bericht, vergelijkbaar met een mededeling op papier en als zodanig te gebruiken:         * Vb01 Vrij bericht         * Vb02 Vrij bericht via webservice     * De verwerkbevestiging       * Bericht om de verwerking van bepaalde gegevens te bevestigen:         * Null Verwerkbevestiging (Null-bericht) 
        /// </summary>
        /// <value>Het soort bericht (zoals gedefinieerd in het berichtenboek in het Logisch Ontwerp).  * Berichten ten behoeve van de bijhouding en de consistentie van de BRP   * Berichten tussen bijhouders onderling     * Berichten in verband met de vervolginschrijving tussen gemeenten:       * Ii01 Initiatie intergemeentelijke verhuizing       * Ib01 Verhuizen PL intergemeentelijk       * Iv01 Verwijsgegevens       * If01 Fout: PL niet te verzenden       * If21 Fout: de ontvangen PL is niet de aangevraagde       * If31 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met de vervolginschrijving van de gemeente naar de RNI:       * Rb01 Verhuizen PL van gemeente naar RNI       * Rv01 Verwijsgegevens       * Rf01 Fout: de ontvangen PL kan niet worden opgenomen       * Rf31 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met de vervolginschrijving van de RNI naar de gemeente:       * Ji01 Initiatie verhuizing PL van RNI naar gemeente       * Jb01 Verhuizen PL van RNI naar gemeente       * Jv01 Verwijsgegevens       * Jf01 Fout: PL niet te verzenden       * Jf21 Fout: de ontvangen PL is niet de aangevraagde       * Jf31 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met een toevallige geboorte:       * Tb01 Toevallige geboorte       * Tv01 Verwijsgegevens       * Tf01 Fout: persoon niet in te schrijven       * Tf11 Fout: de verwijsgegevens zijn niet correct     * Berichten in verband met een toevallige gebeurtenis:       * Tb02 Toevallige gebeurtenis       * Tf21 Fout: gebeurtenisgegevens niet te verwerken     * Berichten in verband met het opnemen van verwijsgegevens:       * Iv11 Verwijsgegevens       * Iv21 Verificatie verwijsgegevens       * If41 Fout: verwijsgegevens kunnen niet worden opgenomen     * Berichten in verband met wijzigen A-nummer in de verwijsgegevens bij gemeenten en bij de RNI:       * Wa01 Wijziging A-nummer       * Wf01 Fout: A-nummerwijziging niet te verwerken   * Berichten ten behoeve van de bijhouding     * Berichten in verband met verblijfstitel:       * Og11 Opnemen gegevens verblijfstitel       * Of11 Fout: opnemen/wijzigen verblijfstitel niet mogelijk   * Berichten ten behoeve van het bijhouden van de persoonsgegevens in BRP-V     * Berichten in verband met synchronisatie met BRP-V:       * Lg01 Synchronisatiebericht       * Lq01 Synchronisatievraag       * La01 Synchronisatieantwoord       * Lf01 Fout: synchronisatievraag niet te beantwoorden     * Berichten in verband met synchroniciteitsselecties:       * Lg01 Synchronisatiebericht * Berichten ten behoeve van de gegevensverstrekkingen   * Berichten in verband met spontane gegevensverstrekkingen als gevolg van afnemersindicaties op persoonslijsten:     * Gv01 Spontane mutatie     * Gv02 Spontane mutatie: infrastructurele wijziging     * Wa11 Wijziging A-nummer ten behoeve van afnemers     * Ng01 Afvoeren PL     * Ag11 Vulbericht     * Ag21 Conditionele gegevensverstrekking     * Ag31 Foutherstelbericht   * Berichten in verband met selecties:     * Sv01 Selectieverstrekking     * Sv11 Niemand geselecteerd   * Berichten in verband met ad hoc vragen:     * Hq01 Ad hoc vraag     * Ha01 Ad hoc antwoord     * Hf01 Fout: ad hoc vraag niet te beantwoorden   * Berichten in verband met ad hoc adresvragen:     * Xq01 Ad hoc adresvraag     * Xa01 Ad hoc adresantwoord     * Xf01 Fout: ad hoc adresvraag niet te beantwoorden   * Berichten in verband met het muteren van afnemersindicaties op persoonslijsten:     * Ap01 Plaatsen afnemersindicatie op persoonslijst     * Ag01 Gegevensverstrekking als gevolg van ad hoc plaatsing afnemersindicatie op persoonslijst     * Af01 Fout: plaatsen afnemersindicatie op persoonslijst onmogelijk     * Av01 Verwijderen afnemersindicatie van persoonslijst     * Af11 Fout: verwijderen afnemersindicatie van persoonslijst onmogelijk * Overige berichten   * Berichten ten behoeve van het onderhouden van de autorisatietabel     * Berichten in verband met het onderhoud van de autorisatietabel:       * Ct01 Toevoegen tabelregel aan Autorisatietabel       * Cw01 Wijzigen tabelregel in Autorisatietabel       * Cb01 Beëindigen tabelregel in Autorisatietabel     * Berichten ten behoeve van het onderhouden van de overige landelijke tabellen       * Dt01 Toevoegen tabelregel       * Dw01 Wijzigen tabelregel     * De protocolfouten       * Berichten om niet voorziene fouten in ontvangen berichten te melden:         * Pf01 Fout: cyclus         * Pf02 Fout: syntax         * Pf03 Fout: inhoudelijk     * Het vrije bericht       * Bericht, vergelijkbaar met een mededeling op papier en als zodanig te gebruiken:         * Vb01 Vrij bericht         * Vb02 Vrij bericht via webservice     * De verwerkbevestiging       * Bericht om de verwerking van bepaalde gegevens te bevestigen:         * Null Verwerkbevestiging (Null-bericht) </value>
        [DataMember(Name = "berichtType", IsRequired = true, EmitDefaultValue = true)]
        public string BerichtType { get; set; }

        /// <summary>
        /// Dit is de referentie naar het bericht zoals deze bekend is bij de &#x60;BRP berichten API&#x60; (UUID). Bij elke interactie met deze dienst omtrent een bericht, wordt deze waarde gebruikt. Het mag, net zoals &#x60;berichtVolgnummer&#x60; gebruikt worden om het bericht uniek te identificeren.
        /// </summary>
        /// <value>Dit is de referentie naar het bericht zoals deze bekend is bij de &#x60;BRP berichten API&#x60; (UUID). Bij elke interactie met deze dienst omtrent een bericht, wordt deze waarde gebruikt. Het mag, net zoals &#x60;berichtVolgnummer&#x60; gebruikt worden om het bericht uniek te identificeren.</value>
        [DataMember(Name = "berichtTransportId", IsRequired = true, EmitDefaultValue = true)]
        public Guid BerichtTransportId { get; set; }
        ...
        /// </summary>
        /// <value>Dit volgnummer is het equivalent van het &#39;Dispatch sequence number&#39;/&#39;MSSequenceNumber&#39; van de mailboxserver. Hiermee kan over verschillende media worden vastgesteld of dit bericht al eerder verwerkt is. Het nummer wordt door deze dienst uniek toegekend aan het bericht.</value>
        [DataMember(Name = "berichtVolgnummer", IsRequired = true, EmitDefaultValue = true)]
        public long BerichtVolgnummer { get; set; }

        /// <summary>
        /// Het unieke nummer van een verzender/ontvanger.
        /// </summary>
        /// <value>Het unieke nummer van een verzender/ontvanger.</value>
        [DataMember(Name = "afzender", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Het tijdstip waarop het bericht door de berichten API ontvangen is</value>
        [DataMember(Name = "dtOntvangen", IsRequired = true, EmitDefaultValue = true)]
        public DateTime DtOntvangen { get; set; }

        /// <summary>
        /// Geeft aan of dit bericht al eens eerder opgehaald is.
        /// </summary>
        /// <value>Geeft aan of dit bericht al eens eerder opgehaald is.</value>
        [DataMember(Name = "opgehaald", IsRequired = true, EmitDefaultValue = true)]
        public bool Opgehaald { get; set; }

        /// <summary>
        /// Tot dit moment zal het bericht beschikbaar zijn op de berichten API.
        /// </summary>
        /// <value>Tot dit moment zal het bericht beschikbaar zijn op de berichten API.</value>
        [DataMember(Name = "dtBewaardTot", IsRequired = true, EmitDefaultValue = true)]
        public DateTime DtBewaardTot { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListMessageKenmerken {\n");
            sb.Append("  BerichtId: ").Append(BerichtId).Append("\n");
            sb.Append("  VerwijzingBerichtId: ").Append(VerwijzingBerichtId).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  BerichtTransportId: ").Append(BerichtTransportId).Append("\n");
            sb.Append("  BerichtVolgnummer: ").Append(BerichtVolgnummer).Append("\n");
            sb.Append("  Afzender: ").Append(Afzender).Append("\n");
            sb.Append("  Ontvanger: ").Append(Ontvanger).Append("\n");
            sb.Append("  DtOntvangen: ").Append(DtOntvangen).Append("\n");
            sb.Append("  Opgehaald: ").Append(Opgehaald).Append("\n");
            sb.Append("  DtBewaardTot: ").Append(DtBewaardTot).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            // BerichtId (string) maxLength
            if (this.BerichtId != null && this.BerichtId.Length > 12)
            {
                yield return new ValidationResult("Invalid value for BerichtId, length must be less than 12.", new [] { "BerichtId" });
            }

            // VerwijzingBerichtId (string) maxLength
            if (this.VerwijzingBerichtId != null && this.VerwijzingBerichtId.Length > 12)
            {
                yield return new ValidationResult("Invalid value for VerwijzingBerichtId, length must be less than 12.", new [] { "VerwijzingBerichtId" });
            }

            // BerichtType (string) maxLength
            if (this.BerichtType != null && this.BerichtType.Length > 4)
            {
                yield return new ValidationResult("Invalid value for BerichtType, length must be less than 4.", new [] { "BerichtType" });
            }

            // Afzender (int) maximum
            if (this.Afzender > (int)9999999)
            {
                yield return new ValidationResult("Invalid value for Afzender, must be a value less than or equal to 9999999.", new [] { "Afzender" });
            }

            // Ontvanger (int) maximum
            if (this.Ontvanger > (int)9999999)
            {
                yield return new ValidationResult("Invalid value for Ontvanger, must be a value less than or equal to 9999999.", new [] { "Ontvanger" });
            }
