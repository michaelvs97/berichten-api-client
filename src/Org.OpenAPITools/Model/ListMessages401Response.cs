...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListMessages401ResponseJsonConverter))]
    [DataContract(Name = "listMessages_401_response")]
    public partial class ListMessages401Response : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessages401Response" /> class
        /// with the <see cref="BBAAUTHF001" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAAUTHF001.</param>
        public ListMessages401Response(BBAAUTHF001 actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessages401Response" /> class
        /// with the <see cref="BBAAUTHF002" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAAUTHF002.</param>
        public ListMessages401Response(BBAAUTHF002 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListMessages401Response(BBAF999 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(BBAAUTHF001) || value is BBAAUTHF001)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBAAUTHF002) || value is BBAAUTHF002)
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BBAAUTHF001, BBAAUTHF002, BBAF999");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `BBAAUTHF001`. If the actual instance is not `BBAAUTHF001`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAAUTHF001</returns>
        public BBAAUTHF001 GetBBAAUTHF001()
        {
            return (BBAAUTHF001)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBAAUTHF002`. If the actual instance is not `BBAAUTHF002`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAAUTHF002</returns>
        public BBAAUTHF002 GetBBAAUTHF002()
        {
            return (BBAAUTHF002)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListMessages401Response {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListMessages401Response.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListMessages401Response
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListMessages401Response</returns>
        public static ListMessages401Response FromJson(string jsonString)
        {
            ListMessages401Response newListMessages401Response = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListMessages401Response;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(BBAAUTHF001).GetProperty("AdditionalProperties") == null)
                {
                    newListMessages401Response = new ListMessages401Response(JsonConvert.DeserializeObject<BBAAUTHF001>(jsonString, ListMessages401Response.SerializerSettings));
                }
                else
                {
                    newListMessages401Response = new ListMessages401Response(JsonConvert.DeserializeObject<BBAAUTHF001>(jsonString, ListMessages401Response.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAAUTHF001");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAAUTHF001: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBAAUTHF002).GetProperty("AdditionalProperties") == null)
                {
                    newListMessages401Response = new ListMessages401Response(JsonConvert.DeserializeObject<BBAAUTHF002>(jsonString, ListMessages401Response.SerializerSettings));
                }
                else
                {
                    newListMessages401Response = new ListMessages401Response(JsonConvert.DeserializeObject<BBAAUTHF002>(jsonString, ListMessages401Response.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAAUTHF002");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAAUTHF002: {1}", jsonString, exception.ToString()));
            }
            ...
            try
            {
                ...
                {
                    newListMessages401Response = new ListMessages401Response(JsonConvert.DeserializeObject<BBAF999>(jsonString, ListMessages401Response.SerializerSettings));
                }
                else
                {
                    newListMessages401Response = new ListMessages401Response(JsonConvert.DeserializeObject<BBAF999>(jsonString, ListMessages401Response.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for ListMessages401Response
    /// </summary>
    public class ListMessages401ResponseJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListMessages401Response).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return ListMessages401Response.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return ListMessages401Response.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
