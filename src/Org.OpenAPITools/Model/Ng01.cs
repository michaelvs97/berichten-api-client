...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Ng01")]
    public partial class Ng01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ng01" /> class.
        /// </summary>
        ...
        public Ng01(string schema = default, string berichtType = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Ng01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Ng01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
