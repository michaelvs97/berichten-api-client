...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Null : IValidatableObject
    {
        /// <summary>
        ...
        public Null(string schema = default, string berichtType = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Null and cannot be null");
            }
