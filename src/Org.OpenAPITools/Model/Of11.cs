...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Of11")]
    public partial class Of11 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Of11" /> class.
        /// </summary>
        ...
        public Of11(string schema = default, string berichtType = default, string foutreden = default, string datum = default, string gemeente = default, string aNummer = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Of11 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "foutreden" is required (not null)
            if (foutreden == null)
            {
                throw new ArgumentNullException("foutreden is a required property for Of11 and cannot be null");
            }
            this.Foutreden = foutreden;
            // to ensure "datum" is required (not null)
            if (datum == null)
            {
                throw new ArgumentNullException("datum is a required property for Of11 and cannot be null");
            }
            this.Datum = datum;
            // to ensure "gemeente" is required (not null)
            if (gemeente == null)
            {
                throw new ArgumentNullException("gemeente is a required property for Of11 and cannot be null");
            }
            this.Gemeente = gemeente;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Of11 and cannot be null");
            }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Datum (string) maxLength
            if (this.Datum != null && this.Datum.Length > 8)
            {
                yield return new ValidationResult("Invalid value for Datum, length must be less than 8.", new [] { "Datum" });
            }

            // Datum (string) minLength
            if (this.Datum != null && this.Datum.Length < 0)
            {
                yield return new ValidationResult("Invalid value for Datum, length must be greater than 0.", new [] { "Datum" });
            }
