...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Og11")]
    public partial class Og11 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Og11" /> class.
        /// </summary>
        ...
        public Og11(string schema = default, string berichtType = default, string herhaling = default, string aNummer = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Og11 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Og11 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Og11 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Og11 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
