...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagineerbaarResultaat")]
    public partial class PagineerbaarResultaat : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagineerbaarResultaat" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagineerbaarResultaat() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagineerbaarResultaat" /> class.
        /// </summary>
        /// <param name="paginering">paginering (required).</param>
        public PagineerbaarResultaat(PagineringResultaat paginering = default)
        {
            // to ensure "paginering" is required (not null)
            if (paginering == null)
            {
                throw new ArgumentNullException("paginering is a required property for PagineerbaarResultaat and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagineerbaarResultaat {\n");
