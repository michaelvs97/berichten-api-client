...
namespace Org.OpenAPITools.Model
{
    ...
    /// PagineringResultaat
    /// </summary>
    [DataContract(Name = "PagineringResultaat")]
    public partial class PagineringResultaat : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagineringResultaat" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagineringResultaat() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagineringResultaat" /> class.
        /// </summary>
        /// <param name="pagineringVerzoek">pagineringVerzoek (required).</param>
        /// <param name="totaalAantalBerichten">totaalAantalBerichten (required) (default to 0).</param>
        /// <param name="aantalBerichtenOpDezePagina">aantalBerichtenOpDezePagina (required) (default to 2000).</param>
        /// <param name="aantalPaginas">aantalPaginas (required) (default to 3).</param>
        /// <param name="huidigePagina">huidigePagina (required).</param>
        /// <param name="eerstePagina">eerstePagina (required).</param>
        /// <param name="laatstePagina">laatstePagina (required).</param>
        public PagineringResultaat(PagineringVerzoek pagineringVerzoek = default, long totaalAantalBerichten = 0, int aantalBerichtenOpDezePagina = 2000, int aantalPaginas = 3, int huidigePagina = default, bool eerstePagina = default, bool laatstePagina = default)
        {
            // to ensure "pagineringVerzoek" is required (not null)
            if (pagineringVerzoek == null)
            {
                throw new ArgumentNullException("pagineringVerzoek is a required property for PagineringResultaat and cannot be null");
            }
            this.PagineringVerzoek = pagineringVerzoek;
            this.TotaalAantalBerichten = totaalAantalBerichten;
            this.AantalBerichtenOpDezePagina = aantalBerichtenOpDezePagina;
            this.AantalPaginas = aantalPaginas;
            this.HuidigePagina = huidigePagina;
            this.EerstePagina = eerstePagina;
            this.LaatstePagina = laatstePagina;
        }

        /// <summary>
        /// Gets or Sets PagineringVerzoek
        /// </summary>
        [DataMember(Name = "pagineringVerzoek", IsRequired = true, EmitDefaultValue = true)]
        public PagineringVerzoek PagineringVerzoek { get; set; }

        /// <summary>
        /// Gets or Sets TotaalAantalBerichten
        /// </summary>
        [DataMember(Name = "totaalAantalBerichten", IsRequired = true, EmitDefaultValue = true)]
        public long TotaalAantalBerichten { get; set; }

        /// <summary>
        /// Gets or Sets AantalBerichtenOpDezePagina
        /// </summary>
        [DataMember(Name = "aantalBerichtenOpDezePagina", IsRequired = true, EmitDefaultValue = true)]
        public int AantalBerichtenOpDezePagina { get; set; }

        /// <summary>
        /// Gets or Sets AantalPaginas
        /// </summary>
        [DataMember(Name = "aantalPaginas", IsRequired = true, EmitDefaultValue = true)]
        public int AantalPaginas { get; set; }

        /// <summary>
        /// Gets or Sets HuidigePagina
        /// </summary>
        [DataMember(Name = "huidigePagina", IsRequired = true, EmitDefaultValue = true)]
        public int HuidigePagina { get; set; }

        /// <summary>
        /// Gets or Sets EerstePagina
        /// </summary>
        [DataMember(Name = "eerstePagina", IsRequired = true, EmitDefaultValue = true)]
        public bool EerstePagina { get; set; }

        /// <summary>
        /// Gets or Sets LaatstePagina
        /// </summary>
        [DataMember(Name = "laatstePagina", IsRequired = true, EmitDefaultValue = true)]
        public bool LaatstePagina { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagineringResultaat {\n");
            sb.Append("  PagineringVerzoek: ").Append(PagineringVerzoek).Append("\n");
            sb.Append("  TotaalAantalBerichten: ").Append(TotaalAantalBerichten).Append("\n");
            sb.Append("  AantalBerichtenOpDezePagina: ").Append(AantalBerichtenOpDezePagina).Append("\n");
            sb.Append("  AantalPaginas: ").Append(AantalPaginas).Append("\n");
            sb.Append("  HuidigePagina: ").Append(HuidigePagina).Append("\n");
            sb.Append("  EerstePagina: ").Append(EerstePagina).Append("\n");
            sb.Append("  LaatstePagina: ").Append(LaatstePagina).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
