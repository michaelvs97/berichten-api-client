...
namespace Org.OpenAPITools.Model
{
    ...
    /// PagineringVerzoek
    /// </summary>
    [DataContract(Name = "PagineringVerzoek")]
    public partial class PagineringVerzoek : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagineringVerzoek" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagineringVerzoek() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagineringVerzoek" /> class.
        /// </summary>
        /// <param name="pagina">pagina (required).</param>
        public PagineringVerzoek(int pagina = default)
        {
            this.Pagina = pagina;
        }
        ...
        /// Gets or Sets Pagina
        /// </summary>
        [DataMember(Name = "pagina", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagineringVerzoek {\n");
        ...
        {
            // Pagina (int) minimum
            if (this.Pagina < (int)0)
            {
                yield return new ValidationResult("Invalid value for Pagina, must be a value greater than or equal to 0.", new [] { "Pagina" });
            }
