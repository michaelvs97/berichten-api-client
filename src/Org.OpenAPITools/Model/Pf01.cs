...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pf01")]
    public partial class Pf01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Pf01" /> class.
        /// </summary>
        ...
        public Pf01(string schema = default, string berichtType = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Pf01 and cannot be null");
            }
