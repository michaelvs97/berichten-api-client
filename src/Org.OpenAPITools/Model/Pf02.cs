...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pf02")]
    public partial class Pf02 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Pf02" /> class.
        /// </summary>
        ...
        public Pf02(string schema = default, string berichtType = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Pf02 and cannot be null");
            }
