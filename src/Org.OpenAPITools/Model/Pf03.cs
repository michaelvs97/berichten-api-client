...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pf03")]
    public partial class Pf03 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Pf03" /> class.
        /// </summary>
        ...
        public Pf03(string schema = default, string berichtType = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Pf03 and cannot be null");
            }
