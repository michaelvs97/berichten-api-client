...
namespace Org.OpenAPITools.Model
{
    ...
    /// PutMessage
    /// </summary>
    [DataContract(Name = "PutMessage")]
    public partial class PutMessage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessage" /> class.
        /// </summary>
        ...
        public PutMessage(PutMessageKenmerken berichtKenmerken = default, LoBericht berichtInhoud = default)
        {
            // to ensure "berichtKenmerken" is required (not null)
            if (berichtKenmerken == null)
            {
                throw new ArgumentNullException("berichtKenmerken is a required property for PutMessage and cannot be null");
            }
            this.BerichtKenmerken = berichtKenmerken;
            // to ensure "berichtInhoud" is required (not null)
            if (berichtInhoud == null)
            {
                throw new ArgumentNullException("berichtInhoud is a required property for PutMessage and cannot be null");
            }
        ...
        public PutMessageKenmerken BerichtKenmerken { get; set; }
