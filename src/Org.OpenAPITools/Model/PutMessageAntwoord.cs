...
namespace Org.OpenAPITools.Model
{
    ...
    /// PutMessageAntwoord
    /// </summary>
    [DataContract(Name = "put-message-antwoord")]
    public partial class PutMessageAntwoord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutMessageAntwoord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoord" /> class.
        /// </summary>
        /// <param name="interactieId">Een uniek ID wat aan het HTTP request gekoppeld wordt. (required).</param>
        /// <param name="verwerkteBerichten">verwerkteBerichten (required).</param>
        /// <param name="nietVerwerkteBerichten">nietVerwerkteBerichten (required).</param>
        public PutMessageAntwoord(Guid interactieId = default, List<PutMessageAntwoordAllOfVerwerkteBerichten> verwerkteBerichten = default, List<PutMessageAntwoordAllOfNietVerwerkteBerichten> nietVerwerkteBerichten = default)
        {
            this.InteractieId = interactieId;
            // to ensure "verwerkteBerichten" is required (not null)
            if (verwerkteBerichten == null)
            {
                throw new ArgumentNullException("verwerkteBerichten is a required property for PutMessageAntwoord and cannot be null");
            }
            this.VerwerkteBerichten = verwerkteBerichten;
            // to ensure "nietVerwerkteBerichten" is required (not null)
            if (nietVerwerkteBerichten == null)
            {
                throw new ArgumentNullException("nietVerwerkteBerichten is a required property for PutMessageAntwoord and cannot be null");
            }
            this.NietVerwerkteBerichten = nietVerwerkteBerichten;
        }
        ...
        /// <summary>
        /// Gets or Sets VerwerkteBerichten
        /// </summary>
        [DataMember(Name = "verwerkteBerichten", IsRequired = true, EmitDefaultValue = true)]
        public List<PutMessageAntwoordAllOfVerwerkteBerichten> VerwerkteBerichten { get; set; }

        /// <summary>
        /// Gets or Sets NietVerwerkteBerichten
        /// </summary>
        [DataMember(Name = "nietVerwerkteBerichten", IsRequired = true, EmitDefaultValue = true)]
        public List<PutMessageAntwoordAllOfNietVerwerkteBerichten> NietVerwerkteBerichten { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutMessageAntwoord {\n");
            sb.Append("  InteractieId: ").Append(InteractieId).Append("\n");
            sb.Append("  VerwerkteBerichten: ").Append(VerwerkteBerichten).Append("\n");
            sb.Append("  NietVerwerkteBerichten: ").Append(NietVerwerkteBerichten).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
