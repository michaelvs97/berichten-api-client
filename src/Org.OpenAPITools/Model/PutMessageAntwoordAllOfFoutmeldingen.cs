...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(PutMessageAntwoordAllOfFoutmeldingenJsonConverter))]
    [DataContract(Name = "put_message_antwoord_allOf_foutmeldingen")]
    public partial class PutMessageAntwoordAllOfFoutmeldingen : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBAPUTF002" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAPUTF002.</param>
        public PutMessageAntwoordAllOfFoutmeldingen(BBAPUTF002 actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBAPUTF003" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAPUTF003.</param>
        public PutMessageAntwoordAllOfFoutmeldingen(BBAPUTF003 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfFoutmeldingen" /> class
        /// with the <see cref="BBAPUTF004" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BBAPUTF004.</param>
        public PutMessageAntwoordAllOfFoutmeldingen(BBAPUTF004 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(BBAPUTF002) || value is BBAPUTF002)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBAPUTF003) || value is BBAPUTF003)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(BBAPUTF004) || value is BBAPUTF004)
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BBAPUTF002, BBAPUTF003, BBAPUTF004");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `BBAPUTF002`. If the actual instance is not `BBAPUTF002`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAPUTF002</returns>
        public BBAPUTF002 GetBBAPUTF002()
        {
            return (BBAPUTF002)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBAPUTF003`. If the actual instance is not `BBAPUTF003`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAPUTF003</returns>
        public BBAPUTF003 GetBBAPUTF003()
        {
            return (BBAPUTF003)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `BBAPUTF004`. If the actual instance is not `BBAPUTF004`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of BBAPUTF004</returns>
        public BBAPUTF004 GetBBAPUTF004()
        {
            return (BBAPUTF004)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutMessageAntwoordAllOfFoutmeldingen {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, PutMessageAntwoordAllOfFoutmeldingen.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of PutMessageAntwoordAllOfFoutmeldingen
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of PutMessageAntwoordAllOfFoutmeldingen</returns>
        public static PutMessageAntwoordAllOfFoutmeldingen FromJson(string jsonString)
        {
            PutMessageAntwoordAllOfFoutmeldingen newPutMessageAntwoordAllOfFoutmeldingen = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newPutMessageAntwoordAllOfFoutmeldingen;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(BBAPUTF002).GetProperty("AdditionalProperties") == null)
                {
                    newPutMessageAntwoordAllOfFoutmeldingen = new PutMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAPUTF002>(jsonString, PutMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newPutMessageAntwoordAllOfFoutmeldingen = new PutMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAPUTF002>(jsonString, PutMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAPUTF002");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAPUTF002: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBAPUTF003).GetProperty("AdditionalProperties") == null)
                {
                    newPutMessageAntwoordAllOfFoutmeldingen = new PutMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAPUTF003>(jsonString, PutMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newPutMessageAntwoordAllOfFoutmeldingen = new PutMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAPUTF003>(jsonString, PutMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAPUTF003");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAPUTF003: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(BBAPUTF004).GetProperty("AdditionalProperties") == null)
                {
                    newPutMessageAntwoordAllOfFoutmeldingen = new PutMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAPUTF004>(jsonString, PutMessageAntwoordAllOfFoutmeldingen.SerializerSettings));
                }
                else
                {
                    newPutMessageAntwoordAllOfFoutmeldingen = new PutMessageAntwoordAllOfFoutmeldingen(JsonConvert.DeserializeObject<BBAPUTF004>(jsonString, PutMessageAntwoordAllOfFoutmeldingen.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("BBAPUTF004");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into BBAPUTF004: {1}", jsonString, exception.ToString()));
            }
    ...
    /// <summary>
    /// Custom JSON converter for PutMessageAntwoordAllOfFoutmeldingen
    /// </summary>
    public class PutMessageAntwoordAllOfFoutmeldingenJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(PutMessageAntwoordAllOfFoutmeldingen).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return PutMessageAntwoordAllOfFoutmeldingen.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return PutMessageAntwoordAllOfFoutmeldingen.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
