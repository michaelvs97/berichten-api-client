...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "put_message_antwoord_allOf_nietVerwerkteBerichten")]
    public partial class PutMessageAntwoordAllOfNietVerwerkteBerichten : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfNietVerwerkteBerichten" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutMessageAntwoordAllOfNietVerwerkteBerichten() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfNietVerwerkteBerichten" /> class.
        /// </summary>
        ...
        /// <param name="foutmeldingen">foutmeldingen (required).</param>
        public PutMessageAntwoordAllOfNietVerwerkteBerichten(int ontvanger = default, string berichtId = default, Guid berichtTransportId = default, List<PutMessageAntwoordAllOfFoutmeldingen> foutmeldingen = default)
        {
            // to ensure "berichtId" is required (not null)
            if (berichtId == null)
            {
                throw new ArgumentNullException("berichtId is a required property for PutMessageAntwoordAllOfNietVerwerkteBerichten and cannot be null");
            }
            this.BerichtId = berichtId;
            this.BerichtTransportId = berichtTransportId;
            // to ensure "foutmeldingen" is required (not null)
            if (foutmeldingen == null)
            {
                throw new ArgumentNullException("foutmeldingen is a required property for PutMessageAntwoordAllOfNietVerwerkteBerichten and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets Foutmeldingen
        /// </summary>
        [DataMember(Name = "foutmeldingen", IsRequired = true, EmitDefaultValue = true)]
        public List<PutMessageAntwoordAllOfFoutmeldingen> Foutmeldingen { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutMessageAntwoordAllOfNietVerwerkteBerichten {\n");
            ...
            sb.Append("  Foutmeldingen: ").Append(Foutmeldingen).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
