...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "put_message_antwoord_allOf_verwerkteBerichten")]
    public partial class PutMessageAntwoordAllOfVerwerkteBerichten : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfVerwerkteBerichten" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutMessageAntwoordAllOfVerwerkteBerichten() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageAntwoordAllOfVerwerkteBerichten" /> class.
        /// </summary>
        ...
        public PutMessageAntwoordAllOfVerwerkteBerichten(int ontvanger = default, string berichtId = default, Guid berichtTransportId = default)
        {
            // to ensure "berichtId" is required (not null)
            if (berichtId == null)
            {
                throw new ArgumentNullException("berichtId is a required property for PutMessageAntwoordAllOfVerwerkteBerichten and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutMessageAntwoordAllOfVerwerkteBerichten {\n");
