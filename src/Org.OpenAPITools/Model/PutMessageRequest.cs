...
namespace Org.OpenAPITools.Model
{
    ...
    /// PutMessageRequest
    /// </summary>
    [DataContract(Name = "put-message-request")]
    public partial class PutMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMessageRequest" /> class.
        /// </summary>
        /// <param name="berichten">berichten (required).</param>
        public PutMessageRequest(List<PutMessage> berichten = default)
        {
            // to ensure "berichten" is required (not null)
            if (berichten == null)
            {
                throw new ArgumentNullException("berichten is a required property for PutMessageRequest and cannot be null");
            }
        ...
        public List<PutMessage> Berichten { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutMessageRequest {\n");
