...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Rf01")]
    public partial class Rf01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rf01" /> class.
        /// </summary>
        ...
        public Rf01(string schema = default, string berichtType = default, string foutreden = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Rf01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "foutreden" is required (not null)
            if (foutreden == null)
            {
                throw new ArgumentNullException("foutreden is a required property for Rf01 and cannot be null");
            }
            this.Foutreden = foutreden;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Rf01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
