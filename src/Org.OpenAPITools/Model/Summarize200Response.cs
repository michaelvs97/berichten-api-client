...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "summarize_200_response")]
    public partial class Summarize200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Summarize200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Summarize200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Summarize200Response" /> class.
        /// </summary>
        /// <param name="interactieId">Een uniek ID wat aan het HTTP request gekoppeld wordt. (required).</param>
        /// <param name="aantalBerichten">Het aantal berichten dat voldeed aan de criteria. (required).</param>
        public Summarize200Response(Guid interactieId = default, int aantalBerichten = default)
        {
        ...
        /// <summary>
        /// Het aantal berichten dat voldeed aan de criteria.
        /// </summary>
        /// <value>Het aantal berichten dat voldeed aan de criteria.</value>
        [DataMember(Name = "aantalBerichten", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Summarize200Response {\n");
            sb.Append("  InteractieId: ").Append(InteractieId).Append("\n");
            sb.Append("  AantalBerichten: ").Append(AantalBerichten).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
