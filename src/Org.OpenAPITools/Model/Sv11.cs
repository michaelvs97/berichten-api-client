...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sv11")]
    public partial class Sv11 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Sv11" /> class.
        /// </summary>
        ...
        public Sv11(string schema = default, string berichtType = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Sv11 and cannot be null");
            }
