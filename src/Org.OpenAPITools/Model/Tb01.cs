...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tb01")]
    public partial class Tb01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tb01" /> class.
        /// </summary>
        ...
        /// <param name="gezochtePersoon">gezochtePersoon (required).</param>
        /// <param name="aktenummer">aktenummer (required).</param>
        /// <param name="plData">plData (required).</param>
        public Tb01(string schema = default, string berichtType = default, string herhaling = default, string gezochtePersoon = default, string aktenummer = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Tb01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Tb01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "gezochtePersoon" is required (not null)
            if (gezochtePersoon == null)
            {
                throw new ArgumentNullException("gezochtePersoon is a required property for Tb01 and cannot be null");
            }
            this.GezochtePersoon = gezochtePersoon;
            // to ensure "aktenummer" is required (not null)
            if (aktenummer == null)
            {
                throw new ArgumentNullException("aktenummer is a required property for Tb01 and cannot be null");
            }
            this.Aktenummer = aktenummer;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Tb01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets GezochtePersoon
        /// </summary>
        [DataMember(Name = "gezochtePersoon", IsRequired = true, EmitDefaultValue = true)]
        public string GezochtePersoon { get; set; }

        /// <summary>
        /// Gets or Sets Aktenummer
        /// </summary>
        [DataMember(Name = "aktenummer", IsRequired = true, EmitDefaultValue = true)]
        public string Aktenummer { get; set; }

        /// <summary>
        /// Gets or Sets PlData
        /// </summary>
        [DataMember(Name = "plData", IsRequired = true, EmitDefaultValue = true)]
        public Af01PlData PlData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Tb01 {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  Herhaling: ").Append(Herhaling).Append("\n");
            sb.Append("  GezochtePersoon: ").Append(GezochtePersoon).Append("\n");
            sb.Append("  Aktenummer: ").Append(Aktenummer).Append("\n");
            sb.Append("  PlData: ").Append(PlData).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // GezochtePersoon (string) maxLength
            if (this.GezochtePersoon != null && this.GezochtePersoon.Length > 2)
            {
                yield return new ValidationResult("Invalid value for GezochtePersoon, length must be less than 2.", new [] { "GezochtePersoon" });
            }

            // GezochtePersoon (string) minLength
            if (this.GezochtePersoon != null && this.GezochtePersoon.Length < 1)
            {
                yield return new ValidationResult("Invalid value for GezochtePersoon, length must be greater than 1.", new [] { "GezochtePersoon" });
            }

            // Aktenummer (string) maxLength
            if (this.Aktenummer != null && this.Aktenummer.Length > 7)
            {
                yield return new ValidationResult("Invalid value for Aktenummer, length must be less than 7.", new [] { "Aktenummer" });
            }

            // Aktenummer (string) minLength
            if (this.Aktenummer != null && this.Aktenummer.Length < 0)
            {
                yield return new ValidationResult("Invalid value for Aktenummer, length must be greater than 0.", new [] { "Aktenummer" });
            }
