...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tf11")]
    public partial class Tf11 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tf11" /> class.
        /// </summary>
        ...
        public Tf11(string schema = default, string berichtType = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Tf11 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Tf11 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
