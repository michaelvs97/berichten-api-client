...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tf21")]
    public partial class Tf21 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tf21" /> class.
        /// </summary>
        ...
        /// <param name="foutreden">foutreden (required).</param>
        /// <param name="gemeente">gemeente (required).</param>
        /// <param name="aNummer">aNummer (required).</param>
        /// <param name="rubrieken">rubrieken (required).</param>
        /// <param name="plData">plData (required).</param>
        public Tf21(string schema = default, string berichtType = default, string foutreden = default, string gemeente = default, string aNummer = default, List<string> rubrieken = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Tf21 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "foutreden" is required (not null)
            if (foutreden == null)
            {
                throw new ArgumentNullException("foutreden is a required property for Tf21 and cannot be null");
            }
            this.Foutreden = foutreden;
            // to ensure "gemeente" is required (not null)
            if (gemeente == null)
            {
                throw new ArgumentNullException("gemeente is a required property for Tf21 and cannot be null");
            }
            this.Gemeente = gemeente;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Tf21 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "rubrieken" is required (not null)
            if (rubrieken == null)
            {
                throw new ArgumentNullException("rubrieken is a required property for Tf21 and cannot be null");
            }
            this.Rubrieken = rubrieken;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Tf21 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets Foutreden
        /// </summary>
        [DataMember(Name = "foutreden", IsRequired = true, EmitDefaultValue = true)]
        public string Foutreden { get; set; }

        /// <summary>
        /// Gets or Sets Gemeente
        /// </summary>
        [DataMember(Name = "gemeente", IsRequired = true, EmitDefaultValue = true)]
        public string Gemeente { get; set; }

        /// <summary>
        /// Gets or Sets ANummer
        /// </summary>
        [DataMember(Name = "aNummer", IsRequired = true, EmitDefaultValue = true)]
        public string ANummer { get; set; }

        /// <summary>
        /// Gets or Sets Rubrieken
        /// </summary>
        [DataMember(Name = "rubrieken", IsRequired = true, EmitDefaultValue = true)]
        public List<string> Rubrieken { get; set; }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Foutreden (string) maxLength
            if (this.Foutreden != null && this.Foutreden.Length > 1)
            {
                yield return new ValidationResult("Invalid value for Foutreden, length must be less than 1.", new [] { "Foutreden" });
            }

            // Foutreden (string) minLength
            if (this.Foutreden != null && this.Foutreden.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Foutreden, length must be greater than 1.", new [] { "Foutreden" });
            }

            // Gemeente (string) maxLength
            if (this.Gemeente != null && this.Gemeente.Length > 4)
            {
                yield return new ValidationResult("Invalid value for Gemeente, length must be less than 4.", new [] { "Gemeente" });
            }

            // Gemeente (string) minLength
            if (this.Gemeente != null && this.Gemeente.Length < 0)
            {
                yield return new ValidationResult("Invalid value for Gemeente, length must be greater than 0.", new [] { "Gemeente" });
            }

            // ANummer (string) maxLength
            if (this.ANummer != null && this.ANummer.Length > 10)
            {
                yield return new ValidationResult("Invalid value for ANummer, length must be less than 10.", new [] { "ANummer" });
            }

            // ANummer (string) minLength
            if (this.ANummer != null && this.ANummer.Length < 0)
            {
                yield return new ValidationResult("Invalid value for ANummer, length must be greater than 0.", new [] { "ANummer" });
            }
