...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Vb01")]
    public partial class Vb01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Vb01" /> class.
        /// </summary>
        ...
        public Vb01(string schema = default, string berichtType = default, string vrijeTekst = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Vb01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "vrijeTekst" is required (not null)
            if (vrijeTekst == null)
            {
                throw new ArgumentNullException("vrijeTekst is a required property for Vb01 and cannot be null");
            }
