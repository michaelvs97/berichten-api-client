...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Vb02")]
    public partial class Vb02 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Vb02" /> class.
        /// </summary>
        ...
        /// <param name="communicatiepartnerAan">communicatiepartnerAan (required).</param>
        /// <param name="communicatiepartnerVan">communicatiepartnerVan (required).</param>
        /// <param name="vrijeTekst">vrijeTekst (required).</param>
        public Vb02(string schema = default, string berichtType = default, string communicatiepartnerAan = default, string communicatiepartnerVan = default, string vrijeTekst = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Vb02 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "communicatiepartnerAan" is required (not null)
            if (communicatiepartnerAan == null)
            {
                throw new ArgumentNullException("communicatiepartnerAan is a required property for Vb02 and cannot be null");
            }
            this.CommunicatiepartnerAan = communicatiepartnerAan;
            // to ensure "communicatiepartnerVan" is required (not null)
            if (communicatiepartnerVan == null)
            {
                throw new ArgumentNullException("communicatiepartnerVan is a required property for Vb02 and cannot be null");
            }
            this.CommunicatiepartnerVan = communicatiepartnerVan;
            // to ensure "vrijeTekst" is required (not null)
            if (vrijeTekst == null)
            {
                throw new ArgumentNullException("vrijeTekst is a required property for Vb02 and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets CommunicatiepartnerAan
        /// </summary>
        [DataMember(Name = "communicatiepartnerAan", IsRequired = true, EmitDefaultValue = true)]
        public string CommunicatiepartnerAan { get; set; }

        /// <summary>
        /// Gets or Sets CommunicatiepartnerVan
        /// </summary>
        [DataMember(Name = "communicatiepartnerVan", IsRequired = true, EmitDefaultValue = true)]
        public string CommunicatiepartnerVan { get; set; }

        /// <summary>
        /// Gets or Sets VrijeTekst
        /// </summary>
        [DataMember(Name = "vrijeTekst", IsRequired = true, EmitDefaultValue = true)]
        public string VrijeTekst { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Vb02 {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  CommunicatiepartnerAan: ").Append(CommunicatiepartnerAan).Append("\n");
            sb.Append("  CommunicatiepartnerVan: ").Append(CommunicatiepartnerVan).Append("\n");
            sb.Append("  VrijeTekst: ").Append(VrijeTekst).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CommunicatiepartnerAan (string) maxLength
            if (this.CommunicatiepartnerAan != null && this.CommunicatiepartnerAan.Length > 7)
            {
                yield return new ValidationResult("Invalid value for CommunicatiepartnerAan, length must be less than 7.", new [] { "CommunicatiepartnerAan" });
            }

            // CommunicatiepartnerAan (string) minLength
            if (this.CommunicatiepartnerAan != null && this.CommunicatiepartnerAan.Length < 0)
            {
                yield return new ValidationResult("Invalid value for CommunicatiepartnerAan, length must be greater than 0.", new [] { "CommunicatiepartnerAan" });
            }

            // CommunicatiepartnerVan (string) maxLength
            if (this.CommunicatiepartnerVan != null && this.CommunicatiepartnerVan.Length > 7)
            {
                yield return new ValidationResult("Invalid value for CommunicatiepartnerVan, length must be less than 7.", new [] { "CommunicatiepartnerVan" });
            }

            // CommunicatiepartnerVan (string) minLength
            if (this.CommunicatiepartnerVan != null && this.CommunicatiepartnerVan.Length < 0)
            {
                yield return new ValidationResult("Invalid value for CommunicatiepartnerVan, length must be greater than 0.", new [] { "CommunicatiepartnerVan" });
            }
