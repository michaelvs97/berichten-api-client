...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Wa01")]
    public partial class Wa01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Wa01" /> class.
        /// </summary>
        ...
        /// <param name="datumGeldigheid">datumGeldigheid (required).</param>
        /// <param name="plData">plData (required).</param>
        public Wa01(string schema = default, string berichtType = default, string herhaling = default, string aNummer = default, string datumGeldigheid = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Wa01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Wa01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Wa01 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "datumGeldigheid" is required (not null)
            if (datumGeldigheid == null)
            {
                throw new ArgumentNullException("datumGeldigheid is a required property for Wa01 and cannot be null");
            }
            this.DatumGeldigheid = datumGeldigheid;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Wa01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets DatumGeldigheid
        /// </summary>
        [DataMember(Name = "datumGeldigheid", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DatumGeldigheid: ").Append(DatumGeldigheid).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DatumGeldigheid (string) maxLength
            if (this.DatumGeldigheid != null && this.DatumGeldigheid.Length > 8)
            {
                yield return new ValidationResult("Invalid value for DatumGeldigheid, length must be less than 8.", new [] { "DatumGeldigheid" });
            }

            // DatumGeldigheid (string) minLength
            if (this.DatumGeldigheid != null && this.DatumGeldigheid.Length < 0)
            {
                yield return new ValidationResult("Invalid value for DatumGeldigheid, length must be greater than 0.", new [] { "DatumGeldigheid" });
            }
