...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Wa11")]
    public partial class Wa11 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Wa11" /> class.
        /// </summary>
        ...
        public Wa11(string schema = default, string berichtType = default, string aNummer = default, string datumGeldigheid = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Wa11 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "aNummer" is required (not null)
            if (aNummer == null)
            {
                throw new ArgumentNullException("aNummer is a required property for Wa11 and cannot be null");
            }
            this.ANummer = aNummer;
            // to ensure "datumGeldigheid" is required (not null)
            if (datumGeldigheid == null)
            {
                throw new ArgumentNullException("datumGeldigheid is a required property for Wa11 and cannot be null");
            }
            this.DatumGeldigheid = datumGeldigheid;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Wa11 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
