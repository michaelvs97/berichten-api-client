...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Xa01")]
    public partial class Xa01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Xa01" /> class.
        /// </summary>
        ...
        /// <param name="plDataSet">plDataSet (required).</param>
        public Xa01(string schema = default, string berichtType = default, List<Af01PlData> plDataSet = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Xa01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "plDataSet" is required (not null)
            if (plDataSet == null)
            {
                throw new ArgumentNullException("plDataSet is a required property for Xa01 and cannot be null");
            }
            this.PlDataSet = plDataSet;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets PlDataSet
        /// </summary>
        [DataMember(Name = "plDataSet", IsRequired = true, EmitDefaultValue = true)]
        public List<Af01PlData> PlDataSet { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Xa01 {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  BerichtType: ").Append(BerichtType).Append("\n");
            sb.Append("  PlDataSet: ").Append(PlDataSet).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
