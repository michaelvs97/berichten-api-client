...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Xf01")]
    public partial class Xf01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Xf01" /> class.
        /// </summary>
        ...
        public Xf01(string schema = default, string berichtType = default, string foutreden = default, List<string> rubrieken = default, string adresfunctie = default, string identificatie = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Xf01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "foutreden" is required (not null)
            if (foutreden == null)
            {
                throw new ArgumentNullException("foutreden is a required property for Xf01 and cannot be null");
            }
            this.Foutreden = foutreden;
            // to ensure "rubrieken" is required (not null)
            if (rubrieken == null)
            {
                throw new ArgumentNullException("rubrieken is a required property for Xf01 and cannot be null");
            }
            this.Rubrieken = rubrieken;
            // to ensure "adresfunctie" is required (not null)
            if (adresfunctie == null)
            {
                throw new ArgumentNullException("adresfunctie is a required property for Xf01 and cannot be null");
            }
            this.Adresfunctie = adresfunctie;
            // to ensure "identificatie" is required (not null)
            if (identificatie == null)
            {
                throw new ArgumentNullException("identificatie is a required property for Xf01 and cannot be null");
            }
            this.Identificatie = identificatie;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Xf01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
