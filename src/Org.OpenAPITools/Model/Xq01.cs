...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Xq01")]
    public partial class Xq01 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Xq01" /> class.
        /// </summary>
        ...
        /// <param name="adresfunctie">adresfunctie (required).</param>
        /// <param name="identificatie">identificatie (required).</param>
        /// <param name="plData">plData (required).</param>
        public Xq01(string schema = default, string berichtType = default, string herhaling = default, List<string> rubrieken = default, string adresfunctie = default, string identificatie = default, Af01PlData plData = default)
        {
            // to ensure "berichtType" is required (not null)
            if (berichtType == null)
            {
                throw new ArgumentNullException("berichtType is a required property for Xq01 and cannot be null");
            }
            this.BerichtType = berichtType;
            // to ensure "herhaling" is required (not null)
            if (herhaling == null)
            {
                throw new ArgumentNullException("herhaling is a required property for Xq01 and cannot be null");
            }
            this.Herhaling = herhaling;
            // to ensure "rubrieken" is required (not null)
            if (rubrieken == null)
            {
                throw new ArgumentNullException("rubrieken is a required property for Xq01 and cannot be null");
            }
            this.Rubrieken = rubrieken;
            // to ensure "adresfunctie" is required (not null)
            if (adresfunctie == null)
            {
                throw new ArgumentNullException("adresfunctie is a required property for Xq01 and cannot be null");
            }
            this.Adresfunctie = adresfunctie;
            // to ensure "identificatie" is required (not null)
            if (identificatie == null)
            {
                throw new ArgumentNullException("identificatie is a required property for Xq01 and cannot be null");
            }
            this.Identificatie = identificatie;
            // to ensure "plData" is required (not null)
            if (plData == null)
            {
                throw new ArgumentNullException("plData is a required property for Xq01 and cannot be null");
            }
            this.PlData = plData;
            this.Schema = schema;
        }
        ...
        /// <summary>
        /// Gets or Sets Adresfunctie
        /// </summary>
        [DataMember(Name = "adresfunctie", IsRequired = true, EmitDefaultValue = true)]
        public string Adresfunctie { get; set; }

        /// <summary>
        /// Gets or Sets Identificatie
        /// </summary>
        [DataMember(Name = "identificatie", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Adresfunctie: ").Append(Adresfunctie).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Adresfunctie (string) maxLength
            if (this.Adresfunctie != null && this.Adresfunctie.Length > 1)
            {
                yield return new ValidationResult("Invalid value for Adresfunctie, length must be less than 1.", new [] { "Adresfunctie" });
            }

            // Adresfunctie (string) minLength
            if (this.Adresfunctie != null && this.Adresfunctie.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Adresfunctie, length must be greater than 1.", new [] { "Adresfunctie" });
            }

            // Identificatie (string) maxLength
            if (this.Identificatie != null && this.Identificatie.Length > 1)
            {
                yield return new ValidationResult("Invalid value for Identificatie, length must be less than 1.", new [] { "Identificatie" });
            }

            // Identificatie (string) minLength
            if (this.Identificatie != null && this.Identificatie.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Identificatie, length must be greater than 1.", new [] { "Identificatie" });
            }
